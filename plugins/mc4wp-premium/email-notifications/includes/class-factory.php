...
class MC4WP_Form_Notification_Factory
{
    ...
    {
        add_filter('mc4wp_form_settings', [ $this, 'settings' ]);
        add_action('mc4wp_form_subscribed', [ $this, 'send_form_notification' ], 10, 4);
        add_action('mc4wp_form_unsubscribed', [ $this, 'send_form_notification' ], 10, 2);
    }
     ...
     * @return bool
     */
    public function send_form_notification(MC4WP_Form $form, $email_address = '', $data = [], $map = [])
    {
