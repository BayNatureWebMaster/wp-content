...
<div class="row sfsi_custom_social_data_setting" id="custom_social_data_setting">
    ...
    <div id="twitterSettingContainer" style="<?php echo $displayTwtSetting; ?>">
        ...
        <div class="radio_section twitterHeading" style="margin-top: 70px;"><?php _e('Twitter:', 'ultimate-social-media-plus'); ?>
        </div>

        <div class="radio_section fb_url twt_fld_2 social_twitter" style="margin-top: 15px;">

            <label>
                <?php _e('Default Tweet text:', 'ultimate-social-media-plus'); ?>
            </label>
            ...
            <p style="margin-left: 237px;">
                <?php _e('In the tweet-text above, insert ${title} where you want the title of the story to get displayed, and ${link} where you want the link to the article to appear.', 'ultimate-social-media-plus'); ?>
            </p>
            <p style="margin-left: 237px;">
                <?php _e('Any other text you enter will always be used as you entered it. Maybe you also want to use #Hashtags or @your_twitter_handle.', 'ultimate-social-media-plus'); ?>
            </p>
            ...
            <div class="contTwitterCard" style="<?php echo $display; ?>">
                ...
                <label>
                    <?php _e('Twitter Cards:', 'ultimate-social-media-plus'); ?>
                </label>

                <p style="margin-left: 237px;padding-top: 7px!important;">
                    <?php _e('Do you want to include pictures and snippets in the tweets?', 'ultimate-social-media-plus'); ?></p>
                ...
                <p style="margin-left: 237px;float: left;clear: both;">
                    <?php _e("If you select «Yes» then if people Tweet about your page, an image and text snippet will be included in the Tweet, increasing the chances that the Tweet will get seen by your sharer’s followers. This feature is called ‘Twitter cards’ and you can read more about it here: <a target='_blank' href='https://dev.twitter.com/cards/overview'>Twitter cards</a>. The picture which will get taken is the one you defined as ‘featured image’ on the respective page (where the Tweet-button appears.)", 'ultimate-social-media-plus'); ?>
                </p>
                ...
                <div class="cardDataContainer" style="<?php echo $cardDisplay; ?>">
                    ...
                    <div class="sfsiplusicnsdvwrp cardWrapper cardTwitterHandle">
                        ...
                        <label>
                            <?php _e('Your Twitter Handle:', 'ultimate-social-media-plus'); ?>
                        </label>
