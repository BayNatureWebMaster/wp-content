...
/**
 * Main WP to Hootsuite Pro class, used to load the Plugin.
 *
 * @package   WP_To_Hootsuite_Pro
 * @author    WP Zinc
 * @version   1.0.0
 */
class WP_To_Hootsuite_Pro {
	...
	public function __construct() {
		...
		$this->plugin->name              = 'wp-to-hootsuite-pro';
	...
	public function initialize() {
		...
		if ( $this->licensing->check_license_key_valid() ) {
			...
			$this->classes->pinterest_api = new WP_To_Social_Pro_Pinterest_API( self::$instance );
			...
			if ( class_exists( 'WP_CLI' ) ) {
				require_once $this->plugin->folder . '/includes/class-wp-to-hootsuite-pro-cli-bulk-publish.php';
				require_once $this->plugin->folder . '/includes/class-wp-to-hootsuite-pro-cli-repost.php';
				$this->classes->cli = new WP_To_Social_Pro_CLI( 'wp-to-hootsuite-pro', 'WP_To_Hootsuite_Pro' );
			}
		}
	 ...
	 *
	 * Typically used by the vendor/ classes
	 *
	 * @since   1.0.6
	 *
