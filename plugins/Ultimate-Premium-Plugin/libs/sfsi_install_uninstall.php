...
function sfsi_plus_add_new_icons_in_saved_desktop_mobile_order($option5 = false, $option1 = false)
{
	...
	$arrNewIcons = array(21 => "fbmessenger", 22 => "mix", 23 => "ok", 24 => "telegram", 25 => "vk", 26 => "weibo", 27 => "xing", 28 => 'mastodon');
...
function sfsi_premium_activate_plugin()
{
	...
	$options5 = array(
		...
		'sfsi_plus_twitter_MouseOverText'	=> __( 'Twitter', 'ultimate-social-media-plus' ),
