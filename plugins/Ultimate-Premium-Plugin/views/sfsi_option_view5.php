...
function selectoption($name, $follow, $visitme)
{
	...
	?>
	<input type="hidden" name="sfsi_premium_lanOnchange_nonce" value="<?php echo wp_create_nonce('getIconPreview'); ?>" />
...
<div class="tab5">
	...
	<div class="row">
		...
		<div class="icons_size">
			<div class="sfsi_plus_colone">
				...
				<input name="sfsi_plus_icons_size" value="<?php echo ($option5['sfsi_plus_icons_size'] != '') ? esc_attr($option5['sfsi_plus_icons_size']) : '20'; ?>" type="text" />
				<ins>
			...
			<div class="sfsi_plus_colone">
				...
				<input name="sfsi_plus_icons_spacing" type="text" value="<?php echo ($option5['sfsi_plus_icons_spacing'] != '') ? esc_attr($option5['sfsi_plus_icons_spacing']) : ''; ?>" />
				<ins>
			...
			<div class="sfsi_plus_colone">
				...
				<input name="sfsi_plus_icons_verical_spacing" type="text" value="<?php echo ($option5['sfsi_plus_icons_verical_spacing'] != '') ? esc_attr($option5['sfsi_plus_icons_verical_spacing']) : ''; ?>" />
				<ins>
					<?php _e('Pixels', 'ultimate-social-media-plus'); ?>
				</ins>
			</div>
	...
	<div class="row sfsi_plus_mobile_icons_setting">
		...
		<div class="icons_size sfsi_plus_mobile_icons_setting_wrpr" style="<?php echo (isset($option5['sfsi_plus_mobile_icon_setting']) && $option5['sfsi_plus_mobile_icon_setting'] == 'yes') ? 'display:block' : 'display:none'; ?>">
			<div class="sfsi_plus_colone">
				...
				<input name="sfsi_plus_icons_mobilesize" value="<?php echo ($option5['sfsi_plus_icons_mobilesize'] != '') ? esc_attr($option5['sfsi_plus_icons_mobilesize']) : ''; ?>" type="text" />
				<ins>
					<?php _e('pixels wide and tall', 'ultimate-social-media-plus'); ?>
				</ins>
			</div>
			...
			<div class="sfsi_plus_colone">
				...
				<input name="sfsi_plus_icons_mobilespacing" type="text" value="<?php echo ($option5['sfsi_plus_icons_mobilespacing'] != '') ? esc_attr($option5['sfsi_plus_icons_mobilespacing']) : ''; ?>" />
				<ins>
					<?php _e('Pixels', 'ultimate-social-media-plus'); ?>
				</ins>
			</div>
			...
			<div class="sfsi_plus_colone">
				...
				<input name="sfsi_plus_icons_verical_mobilespacing" type="text" value="<?php echo ($option5['sfsi_plus_icons_verical_mobilespacing'] != '') ?  esc_attr($option5['sfsi_plus_icons_verical_mobilespacing']) : ''; ?>" />
				<ins>
					<?php _e('Pixels', 'ultimate-social-media-plus'); ?>
				</ins>
			</div>
		...
		<div class="icons_size">
			<ul class="sfsi_plus_new_alignment_option">
				...
				<li class="sfsi_plus_horiZontal_slideup">
					...
					<input name="sfsi_plus_icons_perRow" type="text" value="<?php echo ($option5['sfsi_plus_icons_perRow'] != '') ? esc_attr($option5['sfsi_plus_icons_perRow']) : ''; ?>" />
			...
			<div class="mobile_icons_size">
				<ul class="sfsi_plus_new_alignment_mobile_option">
					...
					<li class="sfsi_plus_horiZontal_mobile_slideup">
						...
						<input name="sfsi_plus_mobile_icons_perRow" type="text" value="<?php echo ($option5['sfsi_plus_mobile_icons_perRow'] != '') ? esc_attr($option5['sfsi_plus_mobile_icons_perRow']) : ''; ?>" />
	...
	<div class="row sfsi_plus_url_shorting_api_type_setting">
		...
		<p><?php _e('The URL Shortener will change your shared URLs into shorter URLs. This is especially important for Twitter (due to the 140 character  limit on) but also for other sharing your content will look less clunky.', 'ultimate-social-media-plus'); ?>
			<br />
			...
			?>
			<input type="hidden" name="sfsi_premium_bitly_v4" value=<?php echo ($is_bitly_new_access_token) ? "yes" : "no"; ?> />
			<div style="<?php echo $sfsi_premium_bitlyv4token_display; ?>" class="sfsi_plus_bitly_access_token">
				...
				<input type="text" readonly name="sfsi_plus_url_shortner_bitly_key" value="<?php echo esc_attr($option5['sfsi_plus_url_shortner_bitly_key']); ?>" style="width:40%;min-height: 40px;">
			</div>

			<a style="<?php echo $sfsi_premium_bitly_display; ?>" href="https://bitly.com/oauth/authorize?client_id=<?php echo BITLY_CLIENT_ID; ?>&redirect_uri=<?php echo BITLY_REDIRECT_URL; ?>&site_url=<?php echo urlencode(site_url()); ?>&nonce=<?php echo wp_create_nonce('sfsi_premium_authorize_bitly'); ?>" onclick="sfsi_premium_open_bitly_newwindow(event)" target="_blank" class="btn btn-info sfsi_plus_bitly_authorize_button" role="button">
				<?php
	...
	<div class="row">
		...
		<div class="icons_size">
			...
			if (isset($facebook_icons_lang) && !empty($facebook_icons_lang)) {
				?>
				<div class="social-img-link"><img src="<?php echo $visit_icon; ?>" alt="<?php _e( 'Facebook', 'ultimate-social-media-plus' ); ?>" /></div>
			<?php } ?>
		</div>
		...
		<div class="icons_size">
			...
			<div class="field language-field">
				<select name="sfsi_plus_youtube_icons_language" id="sfsi_plus_youtube_icons_language" class="sfsi_plus_youtube_icons_language-preview lanOnchange" data-iconUrl="<?php echo $visit_icon; ?>">
					...
					<option value="Visit_us_zh_CN" <?php echo ($option5['sfsi_plus_youtube_icons_language'] == 'Visit_us_zh_CN') ?  'selected="selected"' : ''; ?>>
						中文<span> - << </span> <span><?php _e( 'Visit us', 'ultimate-social-media-plus'); ?></span><span> >> </span>
					</option>

					<option value="Visit_me_zh_CN" <?php echo ($option5['sfsi_plus_youtube_icons_language'] == 'Visit_me_zh_CN') ?  'selected="selected"' : ''; ?>>
						中文<span> - << </span> <span><?php _e( 'Visit me', 'ultimate-social-media-plus'); ?></span><span> >> </span>
					</option>
					...
					<option value="Visit_us_fr_FR" <?php echo ($option5['sfsi_plus_youtube_icons_language'] == 'Visit_us_fr_FR') ?  'selected="selected"' : ''; ?>>
						Français<span> - << </span> <span><?php _e( 'Visit us', 'ultimate-social-media-plus'); ?></span><span> >> </span>
					</option>

					<option value="Visit_me_fr_FR" <?php echo ($option5['sfsi_plus_youtube_icons_language'] == 'Visit_me_fr_FR') ?  'selected="selected"' : ''; ?>>
						Français<span> - << </span> <span><?php _e( 'Visit me', 'ultimate-social-media-plus'); ?></span><span> >> </span>
					</option>
					...
					<option value="visit_us_tr_TR" <?php echo ($option5['sfsi_plus_youtube_icons_language'] == 'visit_us_tr_TR') ?  'selected="selected"' : ''; ?>>
						Türkçe<span> - << </span> <span><?php _e( 'Visit us', 'ultimate-social-media-plus'); ?></span><span> >> </span>
					</option>

					<option value="visit_me_tr_TR" <?php echo ($option5['sfsi_plus_youtube_icons_language'] == 'visit_me_tr_TR') ?  'selected="selected"' : ''; ?>>
						Türkçe<span> - << </span> <span><?php _e( 'Visit me', 'ultimate-social-media-plus'); ?></span><span> >> </span>
					</option>

					<option value="visit_us_vi" <?php echo ($option5['sfsi_plus_youtube_icons_language'] == 'visit_us_vi') ?  'selected="selected"' : ''; ?>>
						Tiếng Việt<span> - << </span> <span><?php _e( 'Visit us', 'ultimate-social-media-plus'); ?></span><span> >> </span>
					</option>
					<option value="visit_me_vi" <?php echo ($option5['sfsi_plus_youtube_icons_language'] == 'visit_me_vi') ?  'selected="selected"' : ''; ?>>
						Tiếng Việt<span> - << </span> <span><?php _e( 'Visit me', 'ultimate-social-media-plus'); ?></span><span> >> </span>
					</option>
		...
		<div class="icons_size">
			...
			<div class="field language-field">
				<select name="sfsi_plus_linkedin_icons_language" id="sfsi_plus_linkedin_icons_language" class="sfsi_plus_linkedin_icons_language-preview lanOnchange" data-iconUrl="<?php echo $visit_icon; ?>">
					<?php
					if (function_exists('icl_object_id') && has_filter('wpml_current_language')) :
						// $my_current_lang = apply_filters( 'wpml_current_language', NULL );
		...
		<div class="icons_size">
			<span>
				<?php _e('Language for Like, Share and Subscribe buttons (Facebook, Twitter, Youtube):', 'ultimate-social-media-plus'); ?>
			</span>
		...
		<div class="row sfsi_plus_mobile_icons_setting sfsi_plus_mobile_open_type_setting">
			...
			<ul class="sfsi_plus_mobile_selection" style="padding-left: 22px">
				<li style="width:146px;">
					<input type="radio" name="sfsi_plus_mobile_open_type_setting" class="styled" value="no" <?php echo ("" == $nocheck_open_type ? "checked=checked" : ""); ?> />
					<label><?php _e("No", 'ultimate-social-media-plus'); ?></label>
				</li>
				<li style="width:146px;">
					<input type="radio" name="sfsi_plus_mobile_open_type_setting" class="styled" value="yes" <?php echo $nocheck_open_type; ?> />
					<label><?php _e("Yes", 'ultimate-social-media-plus'); ?></label>
				</li>
			</ul>
		</div>

		<div class="sfsiplus_row_onl sfsi_premium_mobile_version" style="display:<?php echo ("" == $nocheck_open_type ? "none" : "block"); ?>">
			<?php $key_db = 'sfsi_plus_icons_mobile_ClickPageOpen'; ?>
			<ul class="enough_waffling">
				<li>
					<input name="sfsi_plus_icons_mobile_ClickPageOpen" <?php echo ('no' == $option5[$key_db]) ?  'checked="checked"' : ''; ?> type="radio" value="no" class="styled" />
					<label>
						<?php _e('Current Tab', 'ultimate-social-media-plus'); ?>
					</label>
				</li>
				<li>
					<input name="sfsi_plus_icons_mobile_ClickPageOpen" <?php echo ('window' == $option5[$key_db]) ?  'checked="checked"' : ''; ?> type="radio" value="window" class="styled" />
					<label>
						<?php _e('New Window', 'ultimate-social-media-plus'); ?>
					</label>
				</li>
				<li>
					<input name="sfsi_plus_icons_mobile_ClickPageOpen" <?php echo ('tab' == $option5[$key_db]) ?  'checked="checked"' : ''; ?> type="radio" value="tab" class="styled" />
					<label>
						<?php _e('New Tab', 'ultimate-social-media-plus'); ?>
					</label>
				</li>
	...
	<div class="row new_wind usmi-premium-noopener" <?php echo $should_display_noopener_tab ? 'style="display: none;"' : ""; ?> >
		...
		<div class="sfsiplus_row_onl">
			...
			<ul class="enough_waffling">
                <li>
                    <input name="sfsi_plus_icons_AddNoopener" <?php echo ( ! $was_installed_before || ( $option5['sfsi_plus_icons_ClickPageOpen'] == 'yes' && $option5['sfsi_plus_icons_AddNoopener'] == 'yes' ) ) ? 'checked="true"' : '' ;?> type="radio" value="yes" class="styled"  />
                    <label>
                    	<?php  _e( 'Yes', 'ultimate-social-media-plus' ); ?>
                    </label>
                </li>
                <li>
                    <input name="sfsi_plus_icons_AddNoopener" <?php echo ( !( ! $was_installed_before || ($option5['sfsi_plus_icons_ClickPageOpen'] == 'yes' && $option5['sfsi_plus_icons_AddNoopener'] == 'yes' ))) ? 'checked="true"' : '' ;?> type="radio" value="no" class="styled" />
                    <label>
	...
	<div class="row mouse_txt">
		...
		<div class="space">
			...
			<div class="mouseover_field sfsiplus_rss_section">
				...
				<input name="sfsi_plus_rss_MouseOverText" value="<?php echo (isset($option5['sfsi_plus_rss_MouseOverText']) && $option5['sfsi_plus_rss_MouseOverText'] != '') ?  esc_attr($option5['sfsi_plus_rss_MouseOverText']) : ''; ?>" type="text" />
			</div>
			<div class="mouseover_field sfsiplus_email_section">
				<label>
					<?php _e( 'Email:', 'ultimate-social-media-plus'); ?>
				</label>
				<input name="sfsi_plus_email_MouseOverText" value="<?php echo (isset($option5['sfsi_plus_email_MouseOverText']) && $option5['sfsi_plus_email_MouseOverText'] != '') ?  esc_attr($option5['sfsi_plus_email_MouseOverText']) : ''; ?>" type="text" />
			</div>
			<div class="clear">
				<div class="mouseover_field sfsiplus_twitter_section">
					...
					<input name="sfsi_plus_twitter_MouseOverText" value="<?php echo (isset($option5['sfsi_plus_twitter_MouseOverText']) && $option5['sfsi_plus_twitter_MouseOverText'] != '') ?  esc_attr($option5['sfsi_plus_twitter_MouseOverText']) : ''; ?>" type="text" />
				</div>
				<div class="mouseover_field sfsiplus_fb_section">
					<label>
						<?php _e( 'Facebook:', 'ultimate-social-media-plus'); ?>
					</label>
					<input name="sfsi_plus_facebook_MouseOverText" value="<?php echo (isset($option5['sfsi_plus_facebook_MouseOverText']) && $option5['sfsi_plus_facebook_MouseOverText'] != '') ? esc_attr($option5['sfsi_plus_facebook_MouseOverText']) : ''; ?>" type="text" />
				</div>
			</div>
			...
			<div class="clear">
				...
				<div class="mouseover_field sfsiplus_linkedin_section">
					...
					<input name="sfsi_plus_linkedIn_MouseOverText" value="<?php echo (isset($option5['sfsi_plus_linkedIn_MouseOverText']) && $option5['sfsi_plus_linkedIn_MouseOverText'] != '') ? esc_attr($option5['sfsi_plus_linkedIn_MouseOverText']) : ''; ?>" type="text" />
				</div>
				<div class="mouseover_field sfsiplus_pinterest_section">
					<label>
						<?php _e( 'Pinterest:', 'ultimate-social-media-plus'); ?>
					</label>
					<input name="sfsi_plus_pinterest_MouseOverText" value="<?php echo (isset($option5['sfsi_plus_pinterest_MouseOverText']) && $option5['sfsi_plus_pinterest_MouseOverText'] != '') ? esc_attr($option5['sfsi_plus_pinterest_MouseOverText']) : ''; ?>" type="text" />
				</div>
			</div>
			...
			<div class="clear">
				...
				<div class="mouseover_field sfsiplus_youtube_section">
					...
					<input name="sfsi_plus_youtube_MouseOverText" value="<?php echo (isset($option5['sfsi_plus_youtube_MouseOverText']) && $option5['sfsi_plus_youtube_MouseOverText'] != '') ?  esc_attr($option5['sfsi_plus_youtube_MouseOverText']) : ''; ?>" type="text" />
				</div>
				<div class="mouseover_field sfsiplus_instagram_section">
					<label>
						<?php _e( 'Instagram:', 'ultimate-social-media-plus'); ?>
					</label>
					<input name="sfsi_plus_instagram_MouseOverText" value="<?php echo (isset($option5['sfsi_plus_instagram_MouseOverText']) && $option5['sfsi_plus_instagram_MouseOverText'] != '') ? esc_attr($option5['sfsi_plus_instagram_MouseOverText']) : ''; ?>" type="text" />
				</div>
			</div>
			...
			<div class="clear">
				...
				<div class="mouseover_field sfsiplus_houzz_section">
					...
					<input name="sfsi_plus_houzz_MouseOverText" value="<?php echo (isset($option5['sfsi_plus_houzz_MouseOverText']) && $option5['sfsi_plus_houzz_MouseOverText'] != '') ?  esc_attr($option5['sfsi_plus_houzz_MouseOverText']) : 'Houzz'; ?>" type="text" />
				</div>
				<div class="mouseover_field sfsiplus_snapchat_section">
					<label>
						<?php _e( 'Snapchat:', 'ultimate-social-media-plus'); ?>
					</label>
					<input name="sfsi_plus_snapchat_MouseOverText" value="<?php echo ($option5['sfsi_plus_snapchat_MouseOverText'] != '') ? esc_attr($option5['sfsi_plus_snapchat_MouseOverText']) : 'Snapchat'; ?>" type="text" />
				</div>
			</div>
			...
			<div class="clear">
				...
				<div class="mouseover_field sfsiplus_whatsapp_section">
					...
					<input name="sfsi_plus_whatsapp_MouseOverText" value="<?php echo (isset($option5['sfsi_plus_whatsapp_MouseOverText']) && $option5['sfsi_plus_whatsapp_MouseOverText'] != '') ? esc_attr($option5['sfsi_plus_whatsapp_MouseOverText']) : 'Whatsapp'; ?>" type="text" />
				</div>
				<div class="mouseover_field sfsiplus_skype_section">
					<label>
						<?php _e( 'Skype:', 'ultimate-social-media-plus'); ?>
					</label>
					<input name="sfsi_plus_skype_MouseOverText" value="<?php echo ($option5['sfsi_plus_skype_MouseOverText'] != '') ? esc_attr($option5['sfsi_plus_skype_MouseOverText']) : 'Skype'; ?>" type="text" />
				</div>
			</div>
			...
			<div class="clear">
				...
				<div class="mouseover_field sfsiplus_vimeo_section">
					...
					<input name="sfsi_plus_vimeo_MouseOverText" value="<?php echo (isset($option5['sfsi_plus_vimeo_MouseOverText']) && $option5['sfsi_plus_vimeo_MouseOverText'] != '') ?  esc_attr($option5['sfsi_plus_vimeo_MouseOverText']) : 'Vimeo'; ?>" type="text" />
				</div>
				<div class="mouseover_field sfsiplus_soundcloud_section">
					<label>
						<?php _e( 'Soundcloud:', 'ultimate-social-media-plus'); ?>
					</label>
					<input name="sfsi_plus_soundcloud_MouseOverText" value="<?php echo ($option5['sfsi_plus_soundcloud_MouseOverText'] != '') ? esc_attr($option5['sfsi_plus_soundcloud_MouseOverText']) : 'Soundcloud'; ?>" type="text" />
				</div>
			</div>
			...
			<div class="clear">
				...
				<div class="mouseover_field sfsiplus_yummly_section">
					...
					<input name="sfsi_plus_yummly_MouseOverText" value="<?php echo (isset($option5['sfsi_plus_yummly_MouseOverText']) && $option5['sfsi_plus_yummly_MouseOverText'] != '') ?  esc_attr($option5['sfsi_plus_yummly_MouseOverText']) : 'Yummly'; ?>" type="text" />
				</div>
				<div class="mouseover_field sfsiplus_flickr_section">
					<label>
						<?php _e( 'Flickr:', 'ultimate-social-media-plus'); ?>
					</label>
					<input name="sfsi_plus_flickr_MouseOverText" value="<?php echo ($option5['sfsi_plus_flickr_MouseOverText'] != '') ? esc_attr($option5['sfsi_plus_flickr_MouseOverText']) : 'Flickr'; ?>" type="text" />
				</div>
			</div>
			...
			<div class="clear">
				...
				<div class="mouseover_field sfsiplus_reddit_section">
					...
					<input name="sfsi_plus_reddit_MouseOverText" value="<?php echo (isset($option5['sfsi_plus_reddit_MouseOverText']) && $option5['sfsi_plus_reddit_MouseOverText'] != '') ?  esc_attr($option5['sfsi_plus_reddit_MouseOverText']) : 'Reddit'; ?>" type="text" />
				</div>
				<div class="mouseover_field sfsiplus_tumblr_section">
					<label>
						<?php _e( 'Tumblr:', 'ultimate-social-media-plus'); ?>
					</label>
					<input name="sfsi_plus_tumblr_MouseOverText" value="<?php echo ($option5['sfsi_plus_tumblr_MouseOverText'] != '') ? esc_attr($option5['sfsi_plus_tumblr_MouseOverText']) : 'Tumblr'; ?>" type="text" />
				</div>
			</div>
			...
			<div class="clear">
				...
				<div class="mouseover_field sfsiplus_fbmessenger_section">
					...
					<input name="sfsi_plus_fbmessenger_MouseOverText" value="<?php echo isset($option5['sfsi_plus_fbmessenger_MouseOverText']) && !empty($option5['sfsi_plus_fbmessenger_MouseOverText']) ? esc_attr($option5['sfsi_plus_fbmessenger_MouseOverText']) : ''; ?>" type="text" />
				</div>
				<div class="mouseover_field sfsiplus_gab_section">
					<label>
						<?php _e( 'Gab:', 'ultimate-social-media-plus'); ?>
					</label>
					<input name="sfsi_plus_gab_MouseOverText" value="<?php echo isset($option5['sfsi_plus_gab_MouseOverText']) && !empty($option5['sfsi_plus_gab_MouseOverText']) ? esc_attr($option5['sfsi_plus_gab_MouseOverText']) : ''; ?>" type="text" />
				</div>
			</div>
			...
			<div class="clear">
				...
				<div class="mouseover_field sfsiplus_mix_section">
					...
					<input name="sfsi_plus_mix_MouseOverText" value="<?php echo isset($option5['sfsi_plus_mix_MouseOverText']) && !empty($option5['sfsi_plus_mix_MouseOverText']) ? esc_attr($option5['sfsi_plus_mix_MouseOverText']) : ''; ?>" type="text" />
				</div>
				...
				<div class="mouseover_field sfsiplus_ok_section">
					...
					<input name="sfsi_plus_ok_MouseOverText" value="<?php echo isset($option5['sfsi_plus_ok_MouseOverText']) && !empty($option5['sfsi_plus_ok_MouseOverText']) ? esc_attr($option5['sfsi_plus_ok_MouseOverText']) : ''; ?>" type="text" />
				</div>
			</div>
			...
			<div class="clear">
				<div class="mouseover_field sfsiplus_telegram_section">
					...
					<input name="sfsi_plus_telegram_MouseOverText" value="<?php echo isset($option5['sfsi_plus_telegram_MouseOverText']) && !empty($option5['sfsi_plus_telegram_MouseOverText']) ? esc_attr($option5['sfsi_plus_telegram_MouseOverText']) : ''; ?>" type="text" />
				</div>
				...
				<div class="mouseover_field sfsiplus_vk_section">
					...
					<input name="sfsi_plus_vk_MouseOverText" value="<?php echo isset($option5['sfsi_plus_vk_MouseOverText']) && !empty($option5['sfsi_plus_vk_MouseOverText']) ? esc_attr($option5['sfsi_plus_vk_MouseOverText']) : ''; ?>" type="text" />
				</div>
			</div>
			...
			<div class="clear">
				<div class="mouseover_field sfsiplus_weibo_section">
					...
					<input name="sfsi_plus_weibo_MouseOverText" value="<?php echo isset($option5['sfsi_plus_weibo_MouseOverText']) && !empty($option5['sfsi_plus_weibo_MouseOverText']) ? esc_attr($option5['sfsi_plus_weibo_MouseOverText']) : ''; ?>" type="text" />
				</div>
				...
				<div class="mouseover_field sfsiplus_xing_section">
					...
					<input name="sfsi_plus_xing_MouseOverText" value="<?php echo isset($option5['sfsi_plus_xing_MouseOverText']) && !empty($option5['sfsi_plus_xing_MouseOverText']) ? esc_attr($option5['sfsi_plus_xing_MouseOverText']) : ''; ?>" type="text" />
				</div>
			</div>
			...
			<div class="clear">
				<div class="mouseover_field sfsiplus_copylink_section">
					...
					<input name="sfsi_plus_copylink_MouseOverText" value="<?php echo isset($option5['sfsi_plus_copylink_MouseOverText']) && !empty($option5['sfsi_plus_copylink_MouseOverText']) ? esc_attr($option5['sfsi_plus_copylink_MouseOverText']) : ''; ?>" type="text" />
				</div>
				...
				<div class="mouseover_field sfsiplus_mastodon_section">
					...
					<input name="sfsi_plus_mastodon_MouseOverText" value="<?php echo isset($option5['sfsi_plus_mastodon_MouseOverText']) && !empty($option5['sfsi_plus_mastodon_MouseOverText']) ? esc_attr($option5['sfsi_plus_mastodon_MouseOverText']) : ''; ?>" type="text" />
				</div>
			</div>
			...
			<ul class="sfsi_plus_Facebook_linking_container">
				...
				<li>
					...
					<div class="sfsi_plus_facebook_custom_url_field">
						<input type="text" name="sfsi_plus_facebook_linkingcustom_url" class="add" placeholder="http://" value="<?php echo (isset($option5['sfsi_plus_facebook_linkingcustom_url'])) ? esc_attr($option5['sfsi_plus_facebook_linkingcustom_url']) : ''; ?>">
	...
	<div class="row">
		...
		<div class="sfsi_plus_cumulative_count sfsiCumulatateSection">
			...
			<ul class="sfsi_plus_cumulativecount_ul sfsi_align" style="float:none">
				...
				<li>
					<div class="sfsi_plus_cumulative_count_radio">
						<input name="sfsi_plus_cumulative_count_active" <?php echo ($sfsi_plus_cumulative_count_active == 'no') ?  'checked="checked"' : ''; ?> type="radio" value="no" class="styled" />
					</div>
				...
				<li>
					<div class="sfsi_plus_cumulative_count_radio">
						<input name="sfsi_plus_cumulative_count_active" <?php echo ($sfsi_plus_cumulative_count_active == 'yes') ?  'checked="checked"' : ''; ?> type="radio" value="yes" class="styled" />
					</div>
			...
			<div class="sfsi_premium_aggregate_options" style="display:<?php echo ($sfsi_plus_cumulative_count_active == 'no') ?  'none' : 'block' ?>">
				<div><?php _e( 'Ok cool. You have several options:', 'ultimate-social-media-plus' ) ?></div>
				<div>
					<div style="float:left;margin-right:40px">
						<input name="sfsi_plus_http_cumulative_count_active" <?php echo ($sfsi_plus_http_cumulative_count_active == 'yes') ?  'checked="checked"' : ''; ?> type="radio" value="yes" class="styled" />
					</div>
				...
				<div>
					<div style="float:left;margin-right:40px">
						<input name="sfsi_plus_http_cumulative_count_active" <?php echo ($sfsi_plus_http_cumulative_count_active == 'no') ?  'checked="checked"' : ''; ?> type="radio" value="no" class="styled" />
					</div>
				...
				<div class="sfsi_plus_not_http_cumulative_count_active" style="height:150px;padding-top:15px;display:<?php echo ($sfsi_plus_http_cumulative_count_active == "yes") ? "none" : "block"; ?>">
					<ul class="sfsi_plus_cumulativecount_ul" style="width:100%">
						<li style="width:50%">
							...
							<div style="float:left">
								<input name="sfsi_plus_http_cumulative_count_previous_domain" type="text" value="<?php echo esc_attr($sfsi_plus_http_cumulative_count_previous_domain); ?>" />
							</div>
						...
						<li style="width:50%">
							...
							<div style="float:left">
								<input name="sfsi_plus_http_cumulative_count_new_domain" type="text" value="<?php echo esc_attr($sfsi_plus_http_cumulative_count_new_domain); ?>" />
							</div>
				...
				<div class="sfsi_plus_custom_domain_cumulativecount_ul ">
					...
					<ul class="sfsi_plus_cumulativecount_ul sfsi_align">
						...
						<li class="sfsi_align">
							<div class="sfsi_plus_cumulative_count_radio">
								<input name="sfsi_plus_facebook_cumulative_count_active" <?php echo ($sfsi_plus_facebook_cumulative_count_active == 'yes') ?  'checked="checked"' : ''; ?> type="checkbox" value="yes" class="styled" />
							</div>
						...
						<li class="sfsi_align">
							<div class="sfsi_plus_cumulative_count_radio">
								<input name="sfsi_plus_pinterest_cumulative_count_active" <?php echo ($sfsi_plus_pinterest_cumulative_count_active == 'yes') ?  'checked="checked"' : ''; ?> type="checkbox" value="yes" class="styled" />
							</div>
				...
				<div style="width: fit-content;padding-top: 19px;margin-top: 18px;">
					...
					<ul class="sfsi_plus_cumulativecount_ul sfsi_align">
						...
						<li class="sfsi_align">
							<div class="sfsi_plus_cumulative_count_radio">
								<input name="sfsi_plus_counts_without_slash" <?php echo ($sfsi_plus_counts_without_slash == 'yes') ?  'checked="checked"' : ''; ?> type="radio" value="yes" class="styled" />
							</div>
						...
						<li class="sfsi_align">
							<div class="sfsi_plus_cumulative_count_radio">
								<input name="sfsi_plus_counts_without_slash" <?php echo ($sfsi_plus_counts_without_slash == 'no') ?  'checked="checked"' : ''; ?> type="radio" value="no" class="styled" />
							</div>
			...
			<ul class="sfsi_plus_new_tooltip_option">
				...
				<li class="sfsi_plus_new_tooltip_li">
					<div class="sfsi_plus_new_tooltip_div">
						...
						<div class="field">
							<input name="sfsi_plus_tooltip_Color" data-default-color="#FFF" id="sfsi_plus_tooltip_Color" type="text" value="<?php echo ($option5['sfsi_plus_tooltip_Color'] != '') ? esc_attr($option5['sfsi_plus_tooltip_Color']) : ''; ?>" />
						</div>
					</div>
				</li>
				<li class="sfsi_plus_new_tooltip_li">
					<div class="sfsi_plus_new_tooltip_div">
						...
						<div class="field">
							<input name="sfsi_plus_tooltip_border_Color" data-default-color="#e7e7e7" id="sfsi_plus_tooltip_border_Color" type="text" value="<?php echo ($option5['sfsi_plus_tooltip_border_Color'] != '') ? esc_attr($option5['sfsi_plus_tooltip_border_Color']) : ''; ?>" />
						</div>
					</div>
				</li>
			</ul>
			...
			<ul class="sfsi_plus_new_tooltip_option" style="margin:0!important">
				...
				<li class="sfsi_plus_new_tooltip_li">
					<div class="sfsi_plus_static_path_div sfsi_premium_d_flex_center">
						...
						<div class="field">
							<input name="sfsi_premium_static_path" type="text" value="<?php echo isset($option5['sfsi_premium_static_path']) ? esc_attr($option5['sfsi_premium_static_path']) : ''; ?>" />
						</div>
					</div>
				</li>
			</ul>
	...
	<div class="row new_wind sfsi_premium_external_js">
		...
		<div class="sfsiplus_row_onl" <?php echo $sfsi_plus_loadjscript; ?>>
			...
			<ul class="enough_waffling">
				<li>
					<input name="sfsi_plus_loadjscript" <?php echo ($sfsi_plus_loadjscript == 'yes') ?  'checked="true"' : ''; ?> type="radio" value="yes" class="styled" />
					<label>
				...
				<li>
					<input name="sfsi_plus_loadjscript" <?php echo ($sfsi_plus_loadjscript == 'no') ?  'checked="true"' : ''; ?> type="radio" value="no" class="styled" />
					<label>
			...
			<div class="afterdisable <?php echo isset($option5['sfsi_plus_loadjscript']) && $option5['sfsi_plus_loadjscript'] == "no" ?  'show' : 'hide'  ?>">
				...
				<button class="sfsi_premium_upload_btn  <?php echo !isset($option5['sfsi_plus_jscript_fileName']) || empty($option5['sfsi_plus_jscript_fileName']) ?  'show' : 'hide'  ?>" onclick="sfsi_premium_upload_javascript_libraries(event)"><?php _e('Upload ', 'ultimate-social-media-plus'); ?></button>
				...
				if (isset($option5['sfsi_plus_jscript_fileName']) && !empty($option5['sfsi_plus_jscript_fileName']))
					foreach ($option5['sfsi_plus_jscript_fileName'] as $key =>  $sfsi_premium_js_fileName) {
						...
						?>
					<div class="sfsi_plus_other_btn  <?php echo isset($option5['sfsi_plus_jscript_fileName']) && $option5['sfsi_plus_jscript_fileName'] != "" ?  'show' : 'hide'  ?>" style="margin-bottom: 8px;">
						<div style="display:flex;align-items:center">

							<p class="sfsi_premium_file_name_display" style="margin-right: 10px;word-break: break-all; max-width: 160px;width:160px;">
								<?php echo $sfsi_premium_js_fileName_change[$sfsi_premium_cnt]  ?>
							</p>
							<input type="hidden" name="sfsi_plus_jscript_fileName[]" value="<?php echo $sfsi_premium_js_fileName  ?>">
							<button class="sfsi_premium_otherbtn" id="uploadBtn1" onclick="sfsi_premium_upload_update_javascript_libraries(event)"><?php _e('Update ', 'ultimate-social-media-plus'); ?></button>
							<button class="sfsi_premium_otherbtn" id="remove_project_file" onclick="sfsi_premium_delete_javascript_libraries(event)"><?php _e('Delete ', 'ultimate-social-media-plus'); ?></button>
							<button class="sfsi_premium_otherbtn" id="btn1" onclick="sfsi_premium_upload_more_javascript_libraries(event)"><?php _e('Add New ', 'ultimate-social-media-plus'); ?></button>
						</div>
					</div>
				<?php
				} else {
				...
				?>
					<div class="sfsi_plus_other_btn hide" style="margin-bottom: 8px;">
						<div style="display:flex;align-items:center">
							...
							<input type="hidden" name="sfsi_plus_jscript_fileName[]" value="<?php echo isset($option5['sfsi_plus_jscript_fileName']) && !empty($option5['sfsi_plus_jscript_fileName']) ?    $option5['sfsi_plus_jscript_fileName'] : '' ?>">
							<button class="sfsi_premium_otherbtn" id="uploadBtn1" onclick="sfsi_premium_upload_update_javascript_libraries(event)"><?php _e('Update ', 'ultimate-social-media-plus'); ?></button>
							<button class="sfsi_premium_otherbtn" id="remove_project_file" onclick="sfsi_premium_delete_javascript_libraries(event)"><?php _e('Delete ', 'ultimate-social-media-plus'); ?></button>
							<button class="sfsi_premium_otherbtn" id="btn1" onclick="sfsi_premium_upload_more_javascript_libraries(event)"><?php _e('Add New ', 'ultimate-social-media-plus'); ?></button>
						</div>
	...
	<div class="row new_wind">
		...
		<div style="display: flex;align-items: center;">
			...
			<input name="sfsi_plus_hook_priority_value" type="text" value="<?php echo ($sfsi_plus_hook_priority_value != '') ? esc_attr($sfsi_plus_hook_priority_value) : 20; ?>" class="add" placeholder="" />
		</div>
	...
	<div class="row new_wind">
		...
		<div class="sfsiplus_row_onl">
			...
			<ul class="enough_waffling">
				<li>
					<input name="sfsi_plus_change_number_format" <?php echo ($sfsi_plus_change_number_format == 'yes') ?  'checked="true"' : ''; ?> type="radio" value="yes" class="styled" />
					<label>
						<?php _e('Yes', 'ultimate-social-media-plus'); ?>
					</label>
				</li>
				<li>
					<input name="sfsi_plus_change_number_format" <?php echo ($sfsi_plus_change_number_format == 'no') ?  'checked="true"' : ''; ?> type="radio" value="no" class="styled" />
					<label>
						<?php _e('No', 'ultimate-social-media-plus'); ?>
					</label>
				</li>
	...
	<div class="row new_wind">
		<div class="sfsiplus_row_onl">
			...
			<ul class="enough_waffling">
				<li>
					<input name="sfsi_plus_disable_promotions" <?php echo ( $sfsi_plus_disable_promotions == 'yes') ?  'checked="true"' : ''; ?> type="radio" value="yes" class="styled" />
					<label><?php _e( 'Yes', 'ultimate-social-media-plus' ); ?></label>
				</li>
				<li>
					<input name="sfsi_plus_disable_promotions" <?php echo ( $sfsi_plus_disable_promotions == 'no') ?  'checked="true"' : ''; ?> type="radio" value="no" class="styled" />
					<label><?php _e( 'No', 'ultimate-social-media-plus' ); ?></label>
				</li>
			</ul>
		</div>
