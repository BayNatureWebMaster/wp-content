...
<li>
  <div class="options sfsi_plus_choose_post_types_section" style="<?php echo ( $option8['sfsi_plus_display_button_type']=='responsive_button') ? 'display:none' : ''; ?>">
        ...
        <div class="sfsi_plus_choose_post_type_wrap">
          ...
          <label style="width:356px!important;"><p><?php _e( 'Do you also want to show the icon on taxonomy pages (e.g. category pages)? Select all where you want them to show:', 'ultimate-social-media-plus' ); ?></p></label> 
              ...
              <option value=""><?php _e( '------------- Choose Taxonomies -------------', 'ultimate-social-media-plus' ); ?></option>
                  ...
                  <?php if($tcount>0) {
                      ...
                      foreach ($allTaxonomies as $taxonomy) { 
                        ...
                        ?>
                        <option <?php echo $selected_box; ?> value="<?php echo $taxonomy->name;?>"><?php echo ucfirst( $taxonomy->label ); ?></option>
                      <?php }
                 } ?> 
