...
class Tribe__Events__Community__Captcha__Recaptcha
	...
	protected function get_settings_fields() {
		return [
			...
			'recaptcha-info'      => [
				'type' => 'html',
				'html' => '<p>' . __( 'Provide reCAPTCHA API keys for both fields to enable reCAPTCHA on your Community form.', 'tribe-events-community' ) . '<br><br><em>' . __( 'Note: reCAPTCHA only appears for users who are not logged in.', 'tribe-events-community' ) . '</em></p>',
			],
			'recaptchaPublicKey'  => [
				'type'            => 'text',
	...
	protected function registration_url() {
		 ...
		 */
		return apply_filters( 'tribe_community_events_recaptcha_registration_url', 'https://www.google.com/recaptcha/admin/create' );
	}
