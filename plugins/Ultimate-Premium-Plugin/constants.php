...
define('PLUGIN_CURRENT_VERSION',"16.3");
...
define('SFSI_PLUS_ALLICONS',serialize(array("rss","email","facebook","twitter","share","youtube","pinterest","instagram","houzz","snapchat","whatsapp","skype",'phone',"vimeo","soundcloud","yummly","flickr","reddit","tumblr","linkedin","fbmessenger","gab","mix","ok","telegram","vk","weibo","wechat","xing","copylink", "mastodon")));
