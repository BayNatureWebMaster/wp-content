                    ...
                    <div class="social_icon_like1 cstmdsplyulwpr">
                        <ul>
                            ...
                            <li>
                                ...
                                <a href="#" title="<?php _e( 'Twitter like', 'ultimate-social-media-plus' ); ?>" class="cstmdspltwtr">
                            ...
                            <li>
                                ...
                                <a href="#" title="<?php _e( 'Share', 'ultimate-social-media-plus' ); ?>" class="cstmdsplshr">
                                    <img src="<?php echo SFSI_PLUS_PLUGURL; ?>images/share1.jpg" alt="<?php _e( 'Share', 'ultimate-social-media-plus' ); ?>" />
                                    <span style="display: none;"><?php _e( '18K', 'ultimate-social-media-plus' ); ?></span>
                                </a>
                    ...
                    <?php foreach ($sfsi_premium_responsive_icons['default_icons'] as $icon => $icon_config) :
                        ...
                        <?php if ($icon !== "GooglePlus") { ?>
                            <li class="sfsi_premium_responsive_default_icon_container">
                                ...
                                <input type="text" class="sfsi_premium_responsive_input" name="sfsi_premium_responsive_<?php echo esc_attr($icon) ?>_input" value="<?php echo esc_attr($icon_config["text"]); ?>" />
