...
<div class="tab1">
    ...
    <p>
    	<?php
    		printf(
				__( 'For other platforms (StumbleUpon, Telegram, VK, Twitch, etc.) please %1$scontact us%2$s so that we can send the icon to you (please tell us for which design). You can then upload them as custom icons. %3$sWe didn’t include them into the plugin because it would blow up the size of the plugin.%4$s', 'ultimate-social-media-plus' ),
