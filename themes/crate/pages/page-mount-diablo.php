...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/pages/diablo/css/normalize.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/pages/diablo/css/main.css">
    <script src="<?php echo get_template_directory_uri(); ?>/pages/diablo/js/vendor/modernizr-2.6.1.min.js"></script>
    <script>
...
<div id="container">
	<div id="logo" style="float:left;">
		<a href="https://baynature.org">Back to <img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/bnLogo.png" alt="logo"></a>
	</div>
	...
	<div id="main-image" class="hidden-xs" style="border: 0px solid red; padding:0px; text-align:center; min-width:12px;">
		<img id="spread" src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/spread.jpg" style="position:relative; padding:0px;" width=800 height=400 alt="Scientific illustration of the Mount Diablo fire in three phases."/>
		<img id="panelOne" class="overlay" src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/panelOne.png">
		<img id="panelTwo" class="overlay" src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/panelTwo.png">
		<img id="panelThree" class="overlay" src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/panelThree.png">
		<img class="overlay" src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/overlay_0000_Whispering-Bells.png">
		<img class="overlay" src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/overlay_0001_Tarantula.png" >
		<img class="overlay" src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/overlay_0002_Poppy.png" >
		<img class="overlay" src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/overlay_0003_Pocket-Mouse.png" >
		<img class="overlay" src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/overlay_0004_Mt-Diablo-Fairy-Lantern.png" >
		<img class="overlay" src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/overlay_0005_Morning-Glory.png" >
		<img class="overlay" src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/overlay_0006_Kellogs-Snapdragon.png" >
		<img class="overlay" src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/overlay_0007_Fremont-Star-Lily.png" >
		<img class="overlay" src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/overlay_0008_Fire-Poppy.png" >
		<img class="overlay" src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/overlay_0009_CharcoalBeetle.png">
		<img class="overlay" src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/overlay_0010_Chamise.png">
		<img class="overlay" src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/overlay_0011_California-Thrasher.png" >
		<img class="overlay" src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/overlay_0012_Brewers-Calandrinia.png" >
		<img class="overlay" src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/overlay_0013_Ash-Throated-Flycatcher.png" >
		<img class="overlay" src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/overlay_0014_Alameda-Whipsnake.png" >
		...
		<figure>
			<div id="specimen-nav">
				<div data-id="snake" style="width:250px; height:200px; border:1px solid white; float:left;  padding-left: 100px; padding-top:40px">
					...
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Alameda-Whipsnake.png">
				...
				<div data-id="brewer" style="width:250px; height:200px; border:1px solid white; float:left;  padding-left: 100px; padding-top:40px">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Brewers-Calandrinia.png" width="125px"  height="100px"  >
				...
				<div data-id="californiatrasher" style="width:250px; height:200px; border:1px solid white; float:left;  padding-left: 100px; padding-top:40px">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/California-Thrasher.png" width="125px"  height="100px"  >
				...
				<div data-id="chamise" style="width:250px; height:200px; border:1px solid white; float:left;  padding-left: 100px; padding-top:40px">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Chamise.png" width="125px"  height="100px" >
					<p>4 - Chamise</p>
				</div>
				<div data-id="charcoalbeetle" style="width:250px; height:200px; border:1px solid white; float:left;  padding-left: 100px; padding-top:40px" >
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/CharcoalBeetle.png"  width="125px"  height="100px" >
				...
				<div data-id="fremont" style="width:250px; height:200px; border:1px solid white; float:left;  padding-left: 100px; padding-top:40px">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Fremont-Star-Lily.png"  width="125px"  height="100px" >
				...
				<div data-id="snapdragon" style="width:250px; height:200px; border:1px solid white; float:left;  padding-left: 100px; padding-top:40px">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Kellogs-Snapdragon.png" width="125px"  height="100px" >
				...
				<div data-id="morning" style="width:250px; height:200px; border:1px solid white; float:left;  padding-left: 100px; padding-top:40px">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Morning-Glory.png" width="125px"  height="100px" >
					<p>8 - Morning Glory</p>
				</div>
				<div data-id="fairylantern" style="width:250px; height:200px; border:1px solid white; float:left;  padding-left: 100px; padding-top:40px">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Mt-Diablo-Fairy-Lantern.png"  width="125px"  height="100px" >
				...
				<div data-id="californiapocket" style="width:250px; height:200px; border:1px solid white; float:left;  padding-left: 100px; padding-top:40px">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Pocket-Mouse.png"  width="125px"  height="100px" >
				...
				<div data-id="californiapoppy" style="width:250px; height:200px; border:1px solid white; float:left;  padding-left: 100px; padding-top:40px">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Poppy.png"  width="125px"  height="100px" >
				...
				<div data-id="tarantula" style="width:250px; height:200px; border:1px solid white; float:left;  padding-left: 100px; padding-top:40px">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Tarantula.png" width="125px"  height="100px" >
					<p>12 - Tarantula</p>
				</div>
				<div data-id="whispering" style="width:250px; height:200px; border:1px solid white; float:left;  padding-left: 100px; padding-top:40px">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Whispering-Bells.png" width="125px" height="100px">
				...
				<div data-id="firepoppy" style="width:250px; height:200px; border:1px solid white; float:left;  padding-left: 100px; padding-top:40px">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Fire-Poppy.png" width="125px" height="100px">
					<p>14 - Fire Poppy</p>
				</div>
				<div data-id="ash" style="width:250px; height:200px; border:1px solid white; float:left;  padding-left: 100px; padding-top:40px">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Ash-Throated-Flycatcher.png" width="125px" height="100px">
		...
		<div id="specimen-nav" style="margin-top:5px;">
			<div id="ui-row-one" class="ui-row show-row" style="display:block">
				...
				<div data-id="brewer" style="float:left">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Brewers-Calandrinia.png" >
					<p>2 - Brewer’s Red Maids</p>
				</div>
				<div data-id="californiatrasher" style="float:left">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/California-Thrasher.png" >
					<p>3 - California Thrasher</p>
				</div>
				<div data-id="chamise" style="float:left">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Chamise.png">
					<p>4 - Chamise</p>
				</div>
				<div data-id="charcoalbeetle"  style="float:left">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/CharcoalBeetle.png" >
					<p>5 - Charcoal Beetle</p>
				</div>
				<div data-id="fremont" style="float:left">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Fremont-Star-Lily.png" >
					<p>6 - Fremont Star Lily</p>
				</div>
			</div>
			<div id="ui-row-two" class="ui-row hide-row" style="display:none">
				<div data-id="snapdragon"  style="float:left">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Kellogs-Snapdragon.png">
					<p>7 - Kellog's Snapdragon</p>
				</div>
				<div data-id="morning"  style="float:left">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Morning-Glory.png">
					<p>8 - Morning Glory</p>
				</div>
				<div data-id="fairylantern" style="float:left">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Mt-Diablo-Fairy-Lantern.png" >
					<p>9 - Mount Diablo Fairy Lantern</p>
				</div>
				<div data-id="californiapocket" style="float:left">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Pocket-Mouse.png" >
					<p>10 - California Pocket Mouse</p>
				</div>
				<div data-id="californiapoppy" style="float:left">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Poppy.png" >
					<p>11 - California Poppy</p>
				</div>
				<div data-id="tarantula" style="float:left">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Tarantula.png">
					<p>12 - Tarantula</p>
				</div>
			</div>
			<div id="ui-row-three" class="ui-row hide-row" style="display:none">
				<div data-id="whispering" style="float:left">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Whispering-Bells.png" width="200" height="237">
					<p>13 - Whispering Bells</p>
				</div>
				<div data-id="firepoppy" style="float:left">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Fire-Poppy.png" width="122" height="237">
					<p>14 - Fire Poppy</p>
				</div>
				<div data-id="ash" style="float:left">
					<img src="<?php echo get_template_directory_uri(); ?>/pages/diablo/img/Ash-Throated-Flycatcher.png" width="200" height="201">
					<p>15 - Ash Throated Flycatcher</p>
				</div>
			</div>
		</div>
...
echo '</div>';  // end of Section 3
		?>
            ...
            <script src="<?php echo get_template_directory_uri(); ?>/pages/diablo/js/plugins.js"></script>
            <script src="<?php echo get_template_directory_uri(); ?>/pages/diablo/js/main.js"></script>
            ...
            <script>
               ...
               <script src="<?php echo get_template_directory_uri(); ?>/pages/diablo/css/polyfills/css-filters-polyfill/lib/cssParser.js"></script>
