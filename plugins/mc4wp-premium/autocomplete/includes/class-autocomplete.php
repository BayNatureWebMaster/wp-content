...
class MC4WP_Autocomplete
{
    ...
    public function maybe_enqueue_script(MC4WP_Form $form)
    {
        ...
        wp_enqueue_style('mc4wp-autocomplete', plugins_url('/assets/css/autocomplete.css', $this->plugin_file), [], MC4WP_PREMIUM_VERSION);
        wp_enqueue_script('mc4wp-autocomplete', plugins_url('/assets/js/autocomplete.js', $this->plugin_file), [], MC4WP_PREMIUM_VERSION, true);
