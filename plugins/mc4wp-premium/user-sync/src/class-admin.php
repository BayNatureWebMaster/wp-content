...
class Admin
{
     ...
     * @const string
     */
    public const SETTINGS_CAP = 'manage_options';
    ...
    public function add_hooks()
    {
        ...
        add_filter('mc4wp_admin_menu_items', [ $this, 'add_menu_items' ]);
        add_action('mc4wp_admin_process_user_sync_queue', [ $this, 'process_queue' ]);
        add_action('mc4wp_admin_save_user_sync_settings', [ $this, 'save_settings' ]);
    }
    ...
    public function init()
    {
        ...
        add_filter('plugin_action_links_' . $this->plugin_slug, [ $this, 'add_plugin_settings_link' ]);
    ...
    public function load_assets()
    {
        ...
        wp_enqueue_script('mailchimp-user-sync-wizard', $this->asset_url("/js/admin.js"), [], MC4WP_USER_SYNC_PLUGIN_VERSION, true);
    }
    ...
    public function save_settings()
    {
        ...
        if ($settings['webhook_enabled'] === 1 && ( $old_settings['webhook_enabled'] === 0 || $list_changed )) {
            ...
            if ($webhook_secret !== '') {
                ...
                $redirect_url = add_query_arg([ 'webhook-created' => 0 ], $redirect_url);
            }
        }
