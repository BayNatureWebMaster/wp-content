...
Community is an add-on for The Events Calendar that empowers users to submit and manage their events on your website.
...
Community extends the functionality of The Events Calendar (https://evnt.is/3j) to allow for frontend event submission on your WordPress site. With pretty permalinks enabled, the frontend fields are accessible at the following URLs:
...
You can display the Community Submission Form on any page or post using:
