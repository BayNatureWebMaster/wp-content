...
<div class="tab3">
    ...
    <div class="row <?php echo $sfsi_plus_mouseOver_effect_type; ?> mouse_txt sfsiplusmousetxt tab3">
        ...
        <div class="row">
            ...
            <ul class="sfsiplus_tab_3_icns sfsiplus_tab_3_icns_list">
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'default' ) ? 'checked="true"' : '' ;?> type="radio" value="default" class="styled"  />
                    <label>
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'flat' ) ? 'checked="true"' : '' ;?>  type="radio" value="flat" class="styled" />
                    <label>
                        <?php _e( 'Flat', 'ultimate-social-media-plus' ); ?>
                    </label>
                    <?php
                        $sfsi_plus_rss_bgColor = $sfsi_plus_rss_bgColor_style = $sfsi_plus_email_bgColor = $sfsi_plus_email_bgColor_style = $sfsi_plus_facebook_bgColor = $sfsi_plus_facebook_bgColor_style = $sfsi_plus_twitter_bgColor = $sfsi_plus_twitter_bgColor_style = $sfsi_plus_share_bgColor = $sfsi_plus_share_bgColor_style = $sfsi_plus_youtube_bgColor = $sfsi_plus_youtube_bgColor_style = $sfsi_plus_pinterest_bgColor = $sfsi_plus_pinterest_bgColor_style = $sfsi_plus_linkedin_bgColor = $sfsi_plus_linkedin_bgColor_style = $sfsi_plus_instagram_bgColor = $sfsi_plus_instagram_bgColor_style = $sfsi_plus_houzz_bgColor = $sfsi_plus_houzz_bgColor_style = $sfsi_plus_snapchat_bgColor = $sfsi_plus_snapchat_bgColor_style = $sfsi_plus_whatsapp_bgColor = $sfsi_plus_whatsapp_bgColor_style = $sfsi_plus_skype_bgColor = $sfsi_plus_skype_bgColor_style = $sfsi_plus_phone_bgColor = $sfsi_plus_phone_bgColor_style = $sfsi_plus_vimeo_bgColor = $sfsi_plus_vimeo_bgColor_style = $sfsi_plus_soundcloud_bgColor = $sfsi_plus_soundcloud_bgColor_style = $sfsi_plus_yummly_bgColor = $sfsi_plus_yummly_bgColor_style = $sfsi_plus_flickr_bgColor = $sfsi_plus_flickr_bgColor_style = $sfsi_plus_reddit_bgColor = $sfsi_plus_reddit_bgColor_style = $sfsi_plus_tumblr_bgColor = $sfsi_plus_tumblr_bgColor_style = $sfsi_plus_fbmessenger_bgColor = $sfsi_plus_fbmessenger_bgColor_style = $sfsi_plus_gab_bgColor = $sfsi_plus_gab_bgColor_style = $sfsi_plus_mix_bgColor = $sfsi_plus_mix_bgColor_style = $sfsi_plus_ok_bgColor = $sfsi_plus_ok_bgColor_style = $sfsi_plus_telegram_bgColor = $sfsi_plus_telegram_bgColor_style = $sfsi_plus_vk_bgColor = $sfsi_plus_vk_bgColor_style = $sfsi_plus_wechat_bgColor = $sfsi_plus_wechat_bgColor_style = $sfsi_plus_weibo_bgColor = $sfsi_plus_weibo_bgColor_style = $sfsi_plus_xing_bgColor = $sfsi_plus_xing_bgColor_style = $sfsi_plus_copylink_bgColor = $sfsi_plus_copylink_bgColor_style = $sfsi_plus_mastodon_bgColor = $sfsi_plus_mastodon_bgColor_style = '';
                        ...
                        if ( isset( $option3['sfsi_plus_twitter_bgColor'] ) && $option3['sfsi_plus_twitter_bgColor'] != '' ) {
                            ...
                            $sfsi_plus_twitter_bgColor_style = 'background: #00ACEC';
                        }
                    ...
                    <div class="sfsiplus_icns_tab_3">
                        ...
                        <span class="sfsiplus_row_2_6 sfsiplus_icon_bgcolor sfsiplus_share_section">
                            <span class="sfsiplus_icon_img_wrapper" style="<?php echo esc_attr( $sfsi_plus_share_bgColor_style ); ?>">
                                <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/icons_theme/flat/flat_share.png" alt="" />
                            </span>
                            <span class="sfsiplus_icon_color_picker">
                            <input name="sfsi_plus_share_bgColor" data-default-color="#26AD62" id="sfsi_plus_share_bgColor" class="sfsi_plus_input_bgColor" type="text" value="<?php echo esc_attr( $sfsi_plus_share_bgColor ); ?>" />
                            </span>
                        </span>
                        ...
                        <span class="sfsiplus_row_2_10 sfsiplus_icon_bgcolor sfsiplus_instagram_section">
                            ...
                            <span class="sfsiplus_icon_color_picker">
                            <input name="sfsi_plus_instagram_bgColor" data-default-color="#336699" id="sfsi_plus_instagram_bgColor" class="sfsi_plus_input_bgColor" type="text" value="<?php echo esc_attr( $sfsi_plus_instagram_bgColor ); ?>" />
                            </span>
                        </span>
                        ...
                        <span class="sfsiplus_row_2_12 sfsiplus_icon_bgcolor sfsiplus_snapchat_section">
                            <span class="sfsiplus_icon_img_wrapper" style="<?php echo esc_attr( $sfsi_plus_snapchat_bgColor_style ); ?>">
                                <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/icons_theme/flat/flat_snapchat.png" alt="" />
                            </span>
                            <span class="sfsiplus_icon_color_picker">
                            <input name="sfsi_plus_snapchat_bgColor" data-default-color="#EDEC1F" id="sfsi_plus_snapchat_bgColor" class="sfsi_plus_input_bgColor" type="text" value="<?php echo esc_attr( $sfsi_plus_snapchat_bgColor ); ?>" />
                            </span>
                        </span>
                        ...
                        <span class="sfsiplus_row_2_14 sfsiplus_icon_bgcolor sfsiplus_skype_section">
                            <span class="sfsiplus_icon_img_wrapper" style="<?php echo esc_attr( $sfsi_plus_skype_bgColor_style ); ?>">
                                <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/icons_theme/flat/flat_skype.png" alt="" />
                            </span>
                            <span class="sfsiplus_icon_color_picker">
                            <input name="sfsi_plus_skype_bgColor" data-default-color="#00A9F1" id="sfsi_plus_skype_bgColor" class="sfsi_plus_input_bgColor" type="text" value="<?php echo esc_attr( $sfsi_plus_skype_bgColor ); ?>" />
                            </span>
                        </span>
                        <span class="sfsiplus_row_2_28 sfsiplus_icon_bgcolor sfsiplus_phone_section">
                            <span class="sfsiplus_icon_img_wrapper" style="<?php echo esc_attr( $sfsi_plus_phone_bgColor_style ); ?>">
                                <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/icons_theme/flat/flat_phone.png" alt="" />
                            </span>
                            <span class="sfsiplus_icon_color_picker">
                            <input name="sfsi_plus_phone_bgColor" data-default-color="#51AD47" id="sfsi_plus_phone_bgColor" class="sfsi_plus_input_bgColor" type="text" value="<?php echo esc_attr( $sfsi_plus_phone_bgColor ); ?>" />
                            </span>
                        </span>
                        <span class="sfsiplus_row_2_15 sfsiplus_icon_bgcolor sfsiplus_vimeo_section">
                            <span class="sfsiplus_icon_img_wrapper" style="<?php echo esc_attr( $sfsi_plus_vimeo_bgColor_style ); ?>">
                                <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/icons_theme/flat/flat_vimeo.png" alt="" />
                            </span>
                            <span class="sfsiplus_icon_color_picker">
                            <input name="sfsi_plus_vimeo_bgColor" data-default-color="#1AB7EA" id="sfsi_plus_vimeo_bgColor" class="sfsi_plus_input_bgColor" type="text" value="<?php echo esc_attr( $sfsi_plus_vimeo_bgColor ); ?>" />
                            </span>
                        </span>
                        <span class="sfsiplus_row_2_16 sfsiplus_icon_bgcolor sfsiplus_soundcloud_section">
                            <span class="sfsiplus_icon_img_wrapper" style="<?php echo esc_attr( $sfsi_plus_soundcloud_bgColor_style ); ?>">
                                <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/icons_theme/flat/flat_soundcloud.png" alt="" />
                            </span>
                            <span class="sfsiplus_icon_color_picker">
                            <input name="sfsi_plus_soundcloud_bgColor" data-default-color="#FF541C" id="sfsi_plus_soundcloud_bgColor" class="sfsi_plus_input_bgColor" type="text" value="<?php echo esc_attr( $sfsi_plus_soundcloud_bgColor ); ?>" />
                            </span>
                        </span>
                        <span class="sfsiplus_row_2_17 sfsiplus_icon_bgcolor sfsiplus_yummly_section">
                            <span class="sfsiplus_icon_img_wrapper" style="<?php echo esc_attr( $sfsi_plus_yummly_bgColor_style ); ?>">
                                <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/icons_theme/flat/flat_yummly.png" alt="" />
                            </span>
                            <span class="sfsiplus_icon_color_picker">
                            <input name="sfsi_plus_yummly_bgColor" data-default-color="#E36308" id="sfsi_plus_yummly_bgColor" class="sfsi_plus_input_bgColor" type="text" value="<?php echo esc_attr( $sfsi_plus_yummly_bgColor ); ?>" />
                            </span>
                        </span>
                        <span class="sfsiplus_row_2_18 sfsiplus_icon_bgcolor sfsiplus_flickr_section">
                            <span class="sfsiplus_icon_img_wrapper" style="<?php echo esc_attr( $sfsi_plus_flickr_bgColor_style ); ?>">
                                <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/icons_theme/flat/flat_flickr.png" alt="" />
                            </span>
                            <span class="sfsiplus_icon_color_picker">
                            <input name="sfsi_plus_flickr_bgColor" data-default-color="#FF0084" id="sfsi_plus_flickr_bgColor" class="sfsi_plus_input_bgColor" type="text" value="<?php echo esc_attr( $sfsi_plus_flickr_bgColor ); ?>" />
                            </span>
                        </span>
                        <span class="sfsiplus_row_2_19 sfsiplus_icon_bgcolor sfsiplus_reddit_section">
                            <span class="sfsiplus_icon_img_wrapper" style="<?php echo esc_attr( $sfsi_plus_reddit_bgColor_style ); ?>">
                                <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/icons_theme/flat/flat_reddit.png" alt="" />
                            </span>
                            <span class="sfsiplus_icon_color_picker">
                            <input name="sfsi_plus_reddit_bgColor" data-default-color="#FF642C" id="sfsi_plus_reddit_bgColor" class="sfsi_plus_input_bgColor" type="text" value="<?php echo esc_attr( $sfsi_plus_reddit_bgColor ); ?>" />
                            </span>
                        </span>
                        <span class="sfsiplus_row_2_20 sfsiplus_icon_bgcolor sfsiplus_tumblr_section">
                            <span class="sfsiplus_icon_img_wrapper" style="<?php echo esc_attr( $sfsi_plus_tumblr_bgColor_style ); ?>">
                                <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/icons_theme/flat/flat_tumblr.png" alt="" />
                            </span>
                            <span class="sfsiplus_icon_color_picker">
                            <input name="sfsi_plus_tumblr_bgColor" data-default-color="#36465F" id="sfsi_plus_tumblr_bgColor" class="sfsi_plus_input_bgColor" type="text" value="<?php echo esc_attr( $sfsi_plus_tumblr_bgColor ); ?>" />
                            </span>
                        </span>

                        <span class="sfsiplus_row_2_21 sfsiplus_icon_bgcolor sfsiplus_fbmessenger_section">
                            <span class="sfsiplus_icon_img_wrapper" style="<?php echo esc_attr( $sfsi_plus_fbmessenger_bgColor_style ); ?>">
                                <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/icons_theme/flat/flat_fbmessenger.png" alt="" />
                            </span>
                            <span class="sfsiplus_icon_color_picker">
                            <input name="sfsi_plus_fbmessenger_bgColor" data-default-color="#447BBF" id="sfsi_plus_fbmessenger_bgColor" class="sfsi_plus_input_bgColor" type="text" value="<?php echo esc_attr( $sfsi_plus_fbmessenger_bgColor ); ?>" />
                            </span>
                        </span>
                        <span class="sfsiplus_row_2_30 sfsiplus_icon_bgcolor sfsiplus_gab_section">
                            <span class="sfsiplus_icon_img_wrapper" style="<?php echo esc_attr( $sfsi_plus_gab_bgColor_style ); ?>">
                                <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/icons_theme/flat/flat_gab.png" alt="" />
                            </span>
                            <span class="sfsiplus_icon_color_picker">
                            <input name="sfsi_plus_gab_bgColor" data-default-color="#25CC80" id="sfsi_plus_gab_bgColor" class="sfsi_plus_input_bgColor" type="text" value="<?php echo esc_attr( $sfsi_plus_gab_bgColor ); ?>" />
                            </span>
                        </span>
                        <span class="sfsiplus_row_2_22 sfsiplus_icon_bgcolor sfsiplus_mix_section">
                            <span class="sfsiplus_icon_img_wrapper" style="<?php echo esc_attr( $sfsi_plus_mix_bgColor_style ); ?>">
                                <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/icons_theme/flat/flat_mix.png" alt="" />
                            </span>
                            <span class="sfsiplus_icon_color_picker">
                            <input name="sfsi_plus_mix_bgColor" data-default-color-custom="conic-gradient(from 180deg at 50% 50%, #DE201D 0deg, #DE201D 117.02deg, #FF8126 117.58deg, #FFA623 230.42deg, #FFD51F 231.6deg, #FFD51F 360deg)" id="sfsi_plus_mix_bgColor" class="sfsi_plus_input_bgColor" type="text" value="<?php echo esc_attr( $sfsi_plus_mix_bgColor ); ?>" />
                            </span>
                        </span>
                        ...
                        <span class="sfsiplus_row_2_27 sfsiplus_icon_bgcolor sfsiplus_xing_section">
                            <span class="sfsiplus_icon_img_wrapper" style="<?php echo esc_attr( $sfsi_plus_xing_bgColor_style ); ?>">
                                <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/icons_theme/flat/flat_xing.png" alt="" />
                            </span>
                            <span class="sfsiplus_icon_color_picker">
                            <input name="sfsi_plus_xing_bgColor" data-default-color="#005A60" id="sfsi_plus_xing_bgColor" class="sfsi_plus_input_bgColor" type="text" value="<?php echo esc_attr( $sfsi_plus_xing_bgColor ); ?>" />
                            </span>
                        </span>
                        ...
                        <span class="sfsiplus_row_2_32 sfsiplus_icon_bgcolor sfsiplus_mastodon_section">
                            ...
                            <span class="sfsiplus_icon_color_picker">
                            <input name="sfsi_plus_mastodon_bgColor" data-default-color-custom="#583ED1" id="sfsi_plus_mastodon_bgColor" class="sfsi_plus_input_bgColor" type="text" value="<?php echo esc_attr( $sfsi_plus_mastodon_bgColor ); ?>" />
                            </span>
                        </span>
                    </div>
                </li>
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'thin' ) ? 'checked="true"' : '' ;?>  type="radio" value="thin" class="styled"  />
                    <label>
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'cute' ) ? 'checked="true"' : '' ;?> type="radio" value="cute" class="styled" />
                    <label>
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'cubes' ) ? 'checked="true"' : '' ;?> type="radio" value="cubes" class="styled"  />
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'chrome_blue' ) ? 'checked="true"' : '' ;?>  type="radio" value="chrome_blue" class="styled" />
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'chrome_grey' ) ? 'checked="true"' : '' ;?>  type="radio" value="chrome_grey" class="styled"  />
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'splash' ) ? 'checked="true"' : '' ;?> type="radio" value="splash" class="styled" />
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'orange' ) ? 'checked="true"' : '' ;?> type="radio" value="orange" class="styled"  />
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'crystal' ) ? 'checked="true"' : '' ;?>  type="radio" value="crystal" class="styled" />
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'glossy' ) ? 'checked="true"' : '' ;?>  type="radio" value="glossy" class="styled"  />
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'black' ) ? 'checked="true"' : '' ;?> type="radio" value="black" class="styled" />
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'silver' ) ? 'checked="true"' : '' ;?> type="radio" value="silver" class="styled"  />
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'shaded_dark' ) ? 'checked="true"' : '' ;?>  type="radio" value="shaded_dark" class="styled" />
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'shaded_light' ) ? 'checked="true"' : '' ;?>  type="radio" value="shaded_light" class="styled"  />
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ($sfsi_plus_actvite_theme == 'cool') ? 'checked="true"' : '' ;?>  type="radio" value="cool" class="styled"  />
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'transparent' ) ? 'checked="true"' : '' ;?> type="radio" value="transparent" class="styled" />
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'yellow' ) ? 'checked="true"' : '' ;?> type="radio" value="yellow" class="styled" />
                    <label style="line-height:20px !important;margin-top:15px;  ">
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'glossyblack' ) ? 'checked="true"' : '' ;?> type="radio" value="glossyblack" class="styled" />
                    <label style="line-height:20px !important;margin-top:15px;  ">
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'blackgrunge' ) ? 'checked="true"' : '' ;?> type="radio" value="blackgrunge" class="styled" />
                    <label style="line-height:20px !important;margin-top:15px;  ">
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'waxedwood' ) ? 'checked="true"' : '' ;?> type="radio" value="waxedwood" class="styled" />
                    <label style="line-height:20px !important;margin-top:15px;  ">
                ...
                <li>
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'black2' ) ? 'checked="true"' : '' ;?> type="radio" value="black2" class="styled" />
                    <label style="line-height:20px !important;margin-top:15px;">
                ...
                <li class="cstomskins_upload">
                    <input name="sfsi_plus_actvite_theme" <?php echo ( $sfsi_plus_actvite_theme == 'custom_support') ? 'checked="true"' : '' ;?> type="radio" value="custom_support" class="styled" />
                    <label style="line-height:20px !important;margin-top:15px;">
            ...
            <div class="sub_row stand sec_new" style="margin-left: 0px;">
                ...
                <div id="animationSection" class="radio_section tab_3_option">
                    ...
                    <input name="sfsi_plus_mouseOver" <?php echo ( $sfsi_plus_mouseOver == 'yes' ) ? 'checked="true"' : ''; ?>  type="checkbox" value="yes" class="styled"  />
                    <label>
                    ...
                    <div class="col-md-12 rowmarginleft45 mouse-over-effects <?php echo ( $sfsi_plus_mouseOver == 'yes' ) ? 'show' : 'hide' ;?>">
                        ...
                        <div class="row">
                            ...
                            <input value="same_icons" name="sfsi_plus_mouseOver_effect_type" <?php echo ( $sfsi_plus_mouseOver_effect_type == 'same_icons' ) ? 'checked=checked' : ''; ?> type="radio" class="styled"/>
                        ...
                        <div class="row rowpadding10 rowmarginleft45 same_icons_effects <?php echo ( $sfsi_plus_mouseOver_effect_type == 'same_icons' ) ? 'show' : 'hide'; ?>">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input class="styled" type="radio" name="sfsi_plus_same_icons_mouseOver_effect" value="fade_in" <?php echo ( $sfsi_plus_mouseOver_effect == 'fade_in' ) ? 'checked="true"' : ''; ?>>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="styled" type="radio" name="sfsi_plus_same_icons_mouseOver_effect" value="fade_out" <?php echo ( $sfsi_plus_mouseOver_effect == 'fade_out' ) ? 'checked="true"' : ''; ?>>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="styled" type="radio" name="sfsi_plus_same_icons_mouseOver_effect" value="scale" <?php echo ( $sfsi_plus_mouseOver_effect == 'scale' ) ? 'checked="true"' : ''; ?>>
                            ...
                            <div class="col-md-12 topmargin40">
                                <div class="row">
                                    <div class="col-md-3">
                                        <input class="styled" type="radio" name="sfsi_plus_same_icons_mouseOver_effect" value="combo" <?php echo ( $sfsi_plus_mouseOver_effect == 'combo' ) ? 'checked="true"' : ''; ?>>
                                        <label>
                                    ...
                                    <div class="col-sm-3">
                                        <input class="styled" type="radio" name="sfsi_plus_same_icons_mouseOver_effect" value="combo-fade-out-scale" <?php echo ( $sfsi_plus_mouseOver_effect == 'combo-fade-out-scale' ) ? 'checked="true"' : ''; ?>>
                                        <label>
                        ...
                        <div class="row zerobottompadding other_icons_effects">
                            <input value="other_icons" name="sfsi_plus_mouseOver_effect_type" <?php echo ( $sfsi_plus_mouseOver_effect_type == 'other_icons' ) ? 'checked=checked' : ''; ?> type="radio" class="styled"/>
                         ...
                         <div class="row rowpadding10 rowmarginleft45 other_icons_effects_options <?php echo ( $sfsi_plus_mouseOver_effect_type == 'other_icons' ) ? 'show' : 'hide'; ?>">
                            ...
                            <div class="col-md-12 topmargin10">
                                ...
                                <select name="mouseover_other_icons_transition_effect">
                                    <option <?php echo 'noeffect' == $mouseover_other_icons_transition_effect? "selected=selected" : ""; ?> value="noeffect"><?php _e( 'No effect', 'ultimate-social-media-plus' )?></option>
                                    <option <?php echo 'flip' == $mouseover_other_icons_transition_effect? "selected=selected" : ""; ?> value="flip"><?php _e( 'Flip', 'ultimate-social-media-plus' ); ?></option>
                                </select>
                            </div>
                         </div>
                    </div>
                ...
                <div class="Shuffle_auto">
                    ...
                    <div class="sub_sub_box shuffle_sub <?php echo $shuffleClass; ?>">
                        <p class="radio_section tab_3_option">
                            <input name="sfsi_plus_shuffle_Firstload" <?php echo ( $sfsi_plus_shuffle_Firstload == 'yes' ) ? 'checked="true"' : '' ;?>  type="checkbox" value="yes" class="styled"  />
                            <label>
                                <?php _e( 'When the site is first loaded', 'ultimate-social-media-plus' ); ?>
                            </label>
                        </p>
                        <p class="radio_section tab_3_option">
                            <input name="sfsi_plus_shuffle_interval" <?php echo ( $sfsi_plus_shuffle_interval == 'yes' ) ? 'checked="true"' : '' ;?>  type="checkbox" value="yes" class="styled"  />
                            <label>
                                <?php _e( 'Every', 'ultimate-social-media-plus' ); ?>
                            </label>
                            <input class="smal_inpt" type="text" name="sfsi_plus_shuffle_intervalTime" value="<?php echo ( $sfsi_plus_shuffle_intervalTime != '' ) ? esc_attr($sfsi_plus_shuffle_intervalTime) : ''; ?>" style="padding:0 10px">
                            <label>
    ...
    <div class="save_button tab_3_sav">
         ...
         <a href="javascript:;" id="sfsi_plus_save3" title="<?php _e( 'Save', 'ultimate-social-media-plus' ); ?>" data-nonce="<?php echo $nonce;?>">
