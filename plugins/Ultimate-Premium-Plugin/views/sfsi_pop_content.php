	    ...
	    <div class="sfsi_uploader">
            <div class="sfsi_popupcntnr">
                ...
                <input  type="hidden" name="sfsi_plus_UploadIcons_nonce" value="<?php echo wp_create_nonce('plus_UploadIcons'); ?>"/>
                    <input name=""  type="button" value="<?php _e( 'Upload', 'ultimate-social-media-plus' ); ?>" class="upload_butt" onclick="upload_image_icon_new(this)" />
                </div>
            </div>
        </div>
...
<div class="fb-overlay read-overlay fbex-s2" >
    <div class="pop_up_box_ex sfsi_pop_up adPopWidth" >
        ...
        <div class="adminTooltip" >
           <a href="javascript:">
		   		<img width="51" class="sfsi_premium_wicon" src="<?php echo SFSI_PLUS_PLUGURL; ?>images/fb.png" title="<?php _e( 'Facebook', 'ultimate-social-media-plus' ); ?>" alt="<?php _e( 'Facebook', 'ultimate-social-media-plus' ); ?>" />
		   </a>
           <div class="sfsi_plus_tool_tip_2 sfsi_plus_tool_tip_2_inr sfsi_plus_fb_tool_bdr" style="width: 59px;margin-left: -68.5px;">
               ...
               <div class="sfsi_plus_inside fbb">
                   <div class="fb_1"><img src="<?php echo $visit_iconsUrl."fb.png"; ?>" alt="<?php _e( 'Facebook', 'ultimate-social-media-plus' ); ?>" /></div>
                   <div class="fb_2"><img src="<?php echo $visit_iconsUrl."fblike_bck.png"; ?>" alt="<?php _e( 'Facebook Like', 'ultimate-social-media-plus' ); ?>" /></div>
                   <div class="fb_3"><img src="<?php echo $visit_iconsUrl."fbshare_bck.png"; ?>" alt="<?php _e( 'Facebook Share', 'ultimate-social-media-plus' ); ?>" /></div>
               </div>
           </div>
...
<div class="pop-overlay read-overlay athis-s1" >
    <div class="pop_up_box sfsi_pop_up adPopWidth"  >
        <img src="<?php echo SFSI_PLUS_PLUGURL; ?>images/close.jpg" id="close_popup" alt="<?php _e( 'Close', 'ultimate-social-media-plus' ); ?>" class="sfsicloseBtn" />
    	<h4 id="readmore_text">
    	...
    	<div style="margin: 0px auto;">
			...
			<a href="http://www.addthis.com/bookmark.php?v=250" class="addthis_button">
            	<img width="51" class="sfsi_premium_wicon" src="<?php echo $icons_baseUrl."/".$active_theme; ?>_share.png" title="<?php _e( 'Share', 'ultimate-social-media-plus' ); ?>" alt="share" />
            </a>
...
<div class="pop-overlay read-overlay twex-s2" >
    <div class="pop_up_box_ex sfsi_pop_up adPopWidth" >
        ...
        <div class="adminTooltip" >
        	<a href="javascript:">
            	<img width="51" class="sfsi_premium_wicon" src="<?php echo SFSI_PLUS_PLUGURL; ?>images/twitter.png" title="<?php _e( 'Twitter', 'ultimate-social-media-plus' ); ?>" alt="<?php _e( 'Twitter', 'ultimate-social-media-plus' ); ?>" />
            </a>
            <div class="sfsi_plus_tool_tip_2 sfsi_plus_tool_tip_2_inr sfsi_plus_twt_tool_bdr" style="width: 59px;margin-left: -69.5px;">
           		...
           		<div class="sfsi_plus_inside" >
           			<div class="twt_3"><img src="<?php echo $visit_iconsUrl."twitter.png"; ?>" alt="<?php _e( 'Twitter', 'ultimate-social-media-plus' ); ?>" /></div>
                    <div class="twt_1"><img src="<?php echo $visit_iconsUrl."twfollow_bck.png"; ?>" alt="<?php _e( 'Twitter Follow', 'ultimate-social-media-plus' ); ?>" /></div>
           			<div class="twt_2"><img src="<?php echo $visit_iconsUrl."twtweet_bck.png"; ?>" alt="<?php _e( 'Twitter Share', 'ultimate-social-media-plus' ); ?>" /></div>
          		</div>
            </div>
   		</div>
    </div>
    ...
    <div class="cstmskin_popup" >
        ...
        <div class="cstomskins_wrpr">
            ...
            <ul class="cstmskin_iconlist">
                  ...
                  <?php
                    $arrSkins = array(
                        __( 'RSS', 'ultimate-social-media-plus' )          => [ 'plus_rss_skin', 'sfsiplus_rss_section' ],
                        __( 'Email', 'ultimate-social-media-plus' )        => [ 'plus_email_skin', 'sfsiplus_email_section' ],
                        __( 'Facebook', 'ultimate-social-media-plus' )     => [ 'plus_facebook_skin', 'sfsiplus_facebook_section' ],
                        __( 'Twitter', 'ultimate-social-media-plus' )      => [ 'plus_twitter_skin', 'sfsiplus_twitter_section' ],
                        __( 'Share', 'ultimate-social-media-plus' )        => [ 'plus_share_skin', 'sfsiplus_share_section' ],
                        __( 'Houzz', 'ultimate-social-media-plus' )        => [ 'plus_houzz_skin', 'sfsiplus_houzz_section' ],
                        __( 'Youtube', 'ultimate-social-media-plus' )      => [ 'plus_youtube_skin', 'sfsiplus_youtube_section' ],
                        __( 'Pinterest', 'ultimate-social-media-plus' )    => [ 'plus_pintrest_skin', 'sfsiplus_pinterest_section' ],
                        __( 'Linkedin', 'ultimate-social-media-plus' )     => [ 'plus_linkedin_skin', 'sfsiplus_linkedin_section' ],
                        __( 'Instagram', 'ultimate-social-media-plus' )    => [ 'plus_instagram_skin', 'sfsiplus_instagram_section' ],
                        __( 'WhatsApp', 'ultimate-social-media-plus' )     => [ 'plus_whatsapp_skin', 'sfsiplus_whatsapp_section' ],
                        __( 'Skype', 'ultimate-social-media-plus' )        => [ 'plus_skype_skin', 'sfsiplus_skype_section' ],
                        __( 'Phone', 'ultimate-social-media-plus' )        => [ 'plus_phone_skin', 'sfsiplus_phone_section' ],
                        __( 'Reddit', 'ultimate-social-media-plus' )       => [ 'plus_reddit_skin', 'sfsiplus_reddit_section' ],
                        __( 'Snapchat', 'ultimate-social-media-plus' )     => [ 'plus_snapchat_skin', 'sfsiplus_snapchat_section' ],
                        __( 'Vimeo', 'ultimate-social-media-plus' )        => [ 'plus_vimeo_skin', 'sfsiplus_vimeo_section' ],
                        __( 'Soundcloud', 'ultimate-social-media-plus' )   => [ 'plus_soundcloud_skin', 'sfsiplus_soundcloud_section' ],
                        __( 'Yummly', 'ultimate-social-media-plus' )       => [ 'plus_yummly_skin', 'sfsiplus_yummly_section' ],
                        __( 'Flickr', 'ultimate-social-media-plus' )       => [ 'plus_flickr_skin', 'sfsiplus_flickr_section' ],
                        __( 'Tumblr', 'ultimate-social-media-plus' )       => [ 'plus_tumblr_skin', 'sfsiplus_tumblr_section' ],
                        __( 'Fbmessenger', 'ultimate-social-media-plus' )  => [ 'plus_fbmessenger_skin', 'sfsiplus_fbmessenger_section' ],
                        __( 'Gab', 'ultimate-social-media-plus' )          => [ 'plus_gab_skin',  'sfsiplus_gab_section' ],
                        __( 'Mix', 'ultimate-social-media-plus' )          => [ 'plus_mix_skin', 'sfsiplus_mix_section' ],
                        __( 'Ok', 'ultimate-social-media-plus' )           => [ 'plus_ok_skin', 'sfsiplus_ok_section' ],
                        __( 'Telegram', 'ultimate-social-media-plus' )     => [ 'plus_telegram_skin', 'sfsiplus_telegram_section' ],
                        __( 'VK', 'ultimate-social-media-plus' )           => [ 'plus_vk_skin', 'sfsiplus_vk_section' ],
                        __( 'Weibo', 'ultimate-social-media-plus' )        => [ 'plus_weibo_skin', 'sfsiplus_weibo_section' ],
                        __( 'Wechat', 'ultimate-social-media-plus' )       => [ 'plus_wechat_skin', 'sfsiplus_wechat_section' ],
                        __( 'Xing', 'ultimate-social-media-plus' )         => [ 'plus_xing_skin', 'sfsiplus_xing_section' ],
                        __( 'Copy link', 'ultimate-social-media-plus' )    => [ 'plus_copylink_skin', 'sfsiplus_copylink_section' ],
                        __( 'Mastodon', 'ultimate-social-media-plus' )      => [ 'plus_mastodon_skin', 'sfsiplus_mastodon_section' ],
                    );
