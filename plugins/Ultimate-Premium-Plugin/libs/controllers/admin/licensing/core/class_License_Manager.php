				...
				if( "lifetime" !== strtolower( $expiration ) ) {
					...
					{ 
						...
						if(ULTIMATELYSOCIAL_LICENSING === $license_api_name){
							...
							$echo_text .= sprintf(
											__( ' Renew it by logging into your %1$s account and click on the resume-option under your purchases. Or get a new license here: %2$s', 'ultimate-social-media-plus' ),
											'<a href="https://sellcodes.com/" target="_blank" >Sellcodes.com</a>',
											'<a href="https://sellcodes.com/XdHlrQnc" target="_blank">https://sellcodes.com/XdHlrQnc</a>'
										);
						}
						...
						if(isset($screen->id) && 'toplevel_page_sfsi-plus-options'== $screen->id){
							...
							$echo_text .= sprintf(
											__( ' Go to %1$sPlugin\'s settings page%2$s to recheck the license validaty', 'ultimate-social-media-plus' ),
