...
<div class="tab2">
            ...
            <ul class="sfsi_plus_email_functions_container">
                ...
                <li>
                    ...
                    <div class="sfsi_plus_field">
                        <label><?php _e( 'Your Email:', 'ultimate-social-media-plus' ); ?></label>
                        <input type="text" name="sfsi_plus_email_icons_contact"
                            value="<?php echo (isset($option2['sfsi_plus_email_icons_contact'])) ? esc_attr($option2['sfsi_plus_email_icons_contact']) : '' ;?>">
                    </div>
                </li>
                <li>
                    <div class="sfsiplusicnsdvwrp">
                    ...
                    <div class="sfsi_plus_field">
                        <label><?php _e( 'URL:', 'ultimate-social-media-plus' ); ?></label>
                        <input type="text" name="sfsi_plus_email_icons_pageurl" placeholder="http://"
                            value="<?php echo (isset($option2['sfsi_plus_email_icons_pageurl'])) ? esc_attr($option2['sfsi_plus_email_icons_pageurl']) : '' ;?>">
                    </div>
                </li>
                <li>
                    <div class="sfsiplusicnsdvwrp">
                    ...
                    <div class="sfsi_plus_field">
                        <label><?php _e( 'Subject line:', 'ultimate-social-media-plus' ); ?></label>
                        <input type="text" name="sfsi_plus_email_icons_subject_line" placeholder="http://"
                            value="<?php echo (isset($option2['sfsi_plus_email_icons_subject_line'])) ? esc_attr($option2['sfsi_plus_email_icons_subject_line']) : '${title}' ;?>">
                    </div>
                    <div class="sfsi_plus_field">
                        <label><?php _e( 'Email content:', 'ultimate-social-media-plus' ); ?></label>
            ...
            <div class='sfsi_plus_service_row'>
                <div class='sfsi_plus_service_column'>
                    <ul>
						...
						<li><?php
							printf(
								__( 'Automatically post on %1$sFacebook & Twitter%2$s', 'ultimate-social-media-plus' ),
								'<span>',
								'</span>'
							);
						?></li>
        ...
        <div class="inr_cont twt_tab_2">
            ...
            <div class="radio_section fb_url twt_fld">
                ...
                <input name="sfsi_plus_twitter_followUserName" type="text"
                    value="<?php echo ($option2['sfsi_plus_twitter_followUserName']!='') ? esc_attr($option2['sfsi_plus_twitter_followUserName']) : '' ;?>"
            ...
            <div class="radio_section fb_url twt_fld">
                ...
                <a class="sfsi_navigate_to_question6 <?php echo $classToAddSfsi_navigate_to_question6; ?>"
                    ...
                    style="float: left;margin-left: 10px;margin-top:23px;color:#1a1d20;"><?php _e("To define what will be tweeted, please make the selections under question 6.",'ultimate-social-media-plus'); ?></a>
            </div>
                    ...
                    <div class="cstmutbchnlnmewpr"
                        ...
                        <p class="extra_pp">
                            ...
                            <input name="sfsi_plus_ytube_user" type="url"
                                ...
                                placeholder="<?php  _e( 'Youtube username', 'ultimate-social-media-plus' ); ?>" class="add" />
                        </p>
                    ...
                    <div class="cstmutbchnlidwpr"
                        ...
                        <p class="extra_pp">
                            ...
                            <input name="sfsi_plus_ytube_chnlid" type="text"
                                value="<?php echo (isset($option2['sfsi_plus_ytube_chnlid']) && $option2['sfsi_plus_ytube_chnlid']!='') ? esc_attr($option2['sfsi_plus_ytube_chnlid']) : '' ;?>"
        ...
        <div class="inr_cont">
            ...
            <p class="radio_section fb_url  cus_link instagram_space">
                ...
                <input name="sfsi_plus_instagram_pageUrl" type="text"
                    value="<?php echo (isset($option2['sfsi_plus_instagram_pageUrl']) && $option2['sfsi_plus_instagram_pageUrl']!='') ? esc_attr($option2['sfsi_plus_instagram_pageUrl']) : '' ;?>"
        ...
        <div class="inr_cont linked_tab_2 link_in">
            ...
            <div class="radio_section fb_url link_1">
                ...
                <input name="sfsi_plus_linkedin_pageURL" type="text" placeholder="http://"
                    value="<?php echo ($option2['sfsi_plus_linkedin_pageURL']!='') ? esc_attr($option2['sfsi_plus_linkedin_pageURL']) : '' ;?>"
                    class="add" />
            </div>
            ...
            <div class="radio_section fb_url link_2">
                ...
                <input name="sfsi_plus_linkedin_followCompany" type="text"
                    value="<?php echo ($option2['sfsi_plus_linkedin_followCompany']!='') ? esc_attr($option2['sfsi_plus_linkedin_followCompany']) : '' ;?>"
                    class="add" placeholder="<?php _e( 'Enter company ID, e.g. 123456', 'ultimate-social-media-plus'); ?>" />
            </div>
            ...
            <div class="radio_section fb_url link_4">
                ...
                <input name="sfsi_plus_linkedin_recommendProductId" type="text"
                    value="<?php echo ($option2['sfsi_plus_linkedin_recommendProductId']!='') ? esc_attr($option2['sfsi_plus_linkedin_recommendProductId']) : '' ;?>"
                    class="add link_dbl" placeholder="Enter Product ID, e.g. 1441" /> <input
                    name="sfsi_plus_linkedin_recommendCompany" type="text"
                    value="<?php echo ($option2['sfsi_plus_linkedin_recommendCompany']!='') ? esc_attr($option2['sfsi_plus_linkedin_recommendCompany']) : '' ;?>"
                    class="add" placeholder="<?php _e( 'Enter company name, e.g. Google', 'ultimate-social-media-plus' ); ?>" />
            </div>
        ...
        <div class="inr_cont">
            ...
            <p class="radio_section fb_url  cus_link instagram_space sfsi_align">
                ...
                <input name="sfsi_plus_snapchat_pageUrl" type="text"
                    value="<?php echo (isset($option2['sfsi_plus_snapchat_pageUrl']) && $option2['sfsi_plus_snapchat_pageUrl']!='') ? esc_attr($option2['sfsi_plus_snapchat_pageUrl']) : '' ;?>"
                    placeholder="http://" class="add" />
            </p>
        </div>
    </div>
                    ...
                    <li>
                        ...
                        <div class="tab2">
                            ...
                            <input name="sfsi_plus_whatsapp_message" type="text"
                                value="<?php echo (isset($option2['sfsi_plus_whatsapp_message']) && $option2['sfsi_plus_whatsapp_message']!='') ?  esc_attr($option2['sfsi_plus_whatsapp_message']) : '' ;?>"
                        ...
                        <div class="tab2">
                            ...
                            <input name="sfsi_plus_my_whatsapp_number" type="text"
                                value="<?php echo (isset($option2['sfsi_plus_my_whatsapp_number']) && $option2['sfsi_plus_my_whatsapp_number']!='') ?  esc_attr($option2['sfsi_plus_my_whatsapp_number']) : '' ;?>"
                        ...
                        <div class="tab2" style="padding-left: 0!important">
                            ...
                            <div class="sfsi_plus_whatsapp_number_container" style="max-width:50%">
                                <input name="sfsi_plus_whatsapp_number" type="text"
                                    value="<?php echo (isset($option2['sfsi_plus_whatsapp_number']) && $option2['sfsi_plus_whatsapp_number']!='') ?  esc_attr($option2['sfsi_plus_whatsapp_number']) : '' ;?>" placeholder="" class="add" />
        ...
        <div class="inr_cont">
            ...
            <p class="radio_section fb_url  cus_link instagram_space">
                ...
                <input name="sfsi_plus_vimeo_pageUrl" type="text"
                    value="<?php echo (isset($option2['sfsi_plus_vimeo_pageUrl']) && $option2['sfsi_plus_vimeo_pageUrl']!='') ? esc_attr($option2['sfsi_plus_vimeo_pageUrl']) : '' ;?>"
                    placeholder="http://" class="add" />
            </p>
        </div>
    </div>
        ...
        <div class="inr_cont">
            ...
            <p class="radio_section fb_url  cus_link instagram_space">
                ...
                <input name="sfsi_plus_soundcloud_pageUrl" type="text"
                    value="<?php echo (isset($option2['sfsi_plus_soundcloud_pageUrl']) && $option2['sfsi_plus_soundcloud_pageUrl']!='') ? esc_attr($option2['sfsi_plus_soundcloud_pageUrl']) : '' ;?>"
                    placeholder="http://" class="add" />
            </p>
        </div>
    </div>
    ...
    <div class="row sfsiplus_yummly_section">
        ...
        <label
            class="sfsiLabel infoLabel"><?php _e( 'The Yummly icon can perform several actions. Pick below which ones it should perform. If you select several options, then users can select what they want to do:', 'ultimate-social-media-plus' ); ?></label>
        ...
        <div class="inr_cont">
            ...
            <p class="radio_section fb_url  cus_link instagram_space">
                ...
                <input name="sfsi_plus_flickr_pageUrl" type="text"
                    value="<?php echo (isset($option2['sfsi_plus_flickr_pageUrl']) && $option2['sfsi_plus_flickr_pageUrl']!='') ? esc_attr($option2['sfsi_plus_flickr_pageUrl']) : '' ;?>"
                    placeholder="http://" class="add" />
            </p>
        </div>
    </div>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <input name="sfsi_plus_reddit_pageUrl" type="text"
                            value="<?php echo (isset($option2['sfsi_plus_reddit_pageUrl']) && $option2['sfsi_plus_reddit_pageUrl']!='') ? esc_attr($option2['sfsi_plus_reddit_pageUrl']) : '' ;?>"
                            placeholder="http://" class="add" />
                    </li>
                </ul>
        ...
        <div class="inr_cont">
            ...
            <p class="radio_section fb_url  cus_link instagram_space">
                ...
                <input name="sfsi_plus_tumblr_pageUrl" type="text"
                    value="<?php echo (isset($option2['sfsi_plus_tumblr_pageUrl']) && $option2['sfsi_plus_tumblr_pageUrl']!='') ? esc_attr($option2['sfsi_plus_tumblr_pageUrl']) : '' ;?>"
                    placeholder="http://" class="add" />
            </p>
        </div>
    </div>
    ...
    <div class="row sfsiplus_fbmessenger_section">
        ...
        <label
            class="sfsiLabel infoLabel"><?php _e( 'The Facebook Messenger icon can perform several actions. Pick below which ones it should perform. If you select several options, then users can select what they want to do:', 'ultimate-social-media-plus' ); ?></label>
            ...
            <div class="row notopborder sfsi_premium_only_fbmessangershare"
                ...
                <p class="radio_section">
                    ...
                    <input name="sfsi_plus_fbmessenger_app_id" type="text"
                        value="<?php echo (isset($option2['sfsi_plus_fbmessengerShare_app_id']) && $option2['sfsi_plus_fbmessengerShare_app_id']!='') ?  esc_attr($option2['sfsi_plus_fbmessengerShare_app_id']) : '' ;?>"
    ...
    <div class="row sfsiplus_mix_section">
        ...
        <label
            class="sfsiLabel infoLabel"><?php _e( 'The Mix Icon can perform several actions. Pick below which ones it should perform. If you select several options, then users can select what they want to do:', 'ultimate-social-media-plus' ); ?></label>
    ...
    <div class="row sfsiplus_ok_section">
        ...
        <label
            class="sfsiLabel infoLabel"><?php _e( 'The OK icon can perform several actions. Pick below which ones it should perform. If you select several options, then users can select what they want to do:', 'ultimate-social-media-plus' ); ?></label>
    ...
    <div class="row sfsiplus_telegram_section">
        ...
        <label
            class="sfsiLabel infoLabel"><?php _e( 'The Telegram icon can perform several actions. Pick below which ones it should perform. If you select several options, then users can select what they want to do:', 'ultimate-social-media-plus' ); ?></label>
            ...
            <div class="row notopborder inr_cont">
                ...
                <!-- <div class="row notopborder topmargin10 col-md-offset-03">
                	...
                	<p class="sfsi_plus_pageurl_type">
						...
						<label><?php //_e("Allow users to send me a Telegram-message (Only works on mobile phones)", 'ultimate-social-media-plus'); ?></label>
                    </p>
                ...
                <div class="row topmargin10 notopborder col-md-offset-03 sfsi_premium_d_flex_center">
                    ...
                    <input name="sfsi_plus_telegram_message" type="text"
                        value="<?php echo (isset($option2['sfsi_plus_telegram_message']) && $option2['sfsi_plus_telegram_message']!='') ? esc_attr($option2['sfsi_plus_telegram_message']) : '' ;?>"
                        placeholder="<?php  _e( 'Hey, I like your website.', 'ultimate-social-media-plus' ); ?>" class="add" />
                </div>
                ...
                <div class="row notopborder col-md-offset-03 sfsi_premium_d_flex_center">
                    ...
                    <input name="sfsi_plus_telegram_username" type="text"
                        value="<?php echo (isset($option2['sfsi_plus_telegram_username']) && $option2['sfsi_plus_telegram_username']!='') ? esc_attr($option2['sfsi_plus_telegram_username']) : '' ;?>"
                        placeholder="" class="add" />
                </div>
                ...
                <!--<div class="row notopborder col-md-offset-03">
					...
					<div class="col-md-9">
					<label class="clear sfsiLabel noteLabel"><a target="_blank" href="https://telegram.org/blog/usernames-and-secret-chats-v2"><?php //_e("*Don't have username. Click here to know 'How to setup a telegram username'" , 'ultimate-social-media-plus');?></a></label>
					</div>
				</div>-->
            	...
            	<div class="row notopborder topmargin10 col-md-offset-03">
                	...
                	<p class="sfsi_plus_pageurl_type">
						...
						<label><?php //_e("Allow users to share the page via Telegram", 'ultimate-social-media-plus'); ?></label>
                    </p>
    ...
    <div class="row sfsiplus_vk_section">
        ...
        <label
            class="sfsiLabel infoLabel"><?php _e( 'The VK icon can perform several actions. Pick below which ones it should perform. If you select several options, then users can select what they want to do:', 'ultimate-social-media-plus' ); ?></label>
    ...
    <div class="row sfsiplus_weibo_section">
        ...
        <label
            class="sfsiLabel infoLabel"><?php _e( 'The Weibo icon can perform several actions. Pick below which ones it should perform. If you select several options, then users can select what they want to do:', 'ultimate-social-media-plus' ); ?></label>
    ...
    <div class="row sfsiplus_wechat_section"
        ...
        <label
            class="sfsiLabel infoLabel"><?php _e( 'The WeChat icon can perform several actions. Pick below which ones it should perform. If you select several options, then users can select what they want to do.', 'ultimate-social-media-plus' ); ?></label>
                ...
                <div class="sfsi_premium_wechat_follow_desc"
                    ...
                    <div
                        ...
                        <div style="text-align:center">
                            <a href="" onclick="upload_image_wechat_scan(event)"
                                class="upload_butt"><?php _e( 'Upload QR code image ','ultimate-social-media-plus');?></a>
                        </div>
                    </div>
                    <div class="sfsi_plus_wechat_display  <?php echo isset($option2['sfsi_premium_wechat_scan_image'])&&$option2['sfsi_premium_wechat_scan_image']!=="" ?  'show' : 'hide'  ?>"
                        ...
                        <img class="sfsi_plus_wechat_folow_image" style="width:300px;height:250px;"
                            ...
                            alt="<?php _e( 'WeChat Follow Scan Image','ultimate-social-media-plus');?>"><br><br>
                        ...
                        <a href=""
                            ...
                            class="upload_butt"><?php _e( 'Delete QR code image ','ultimate-social-media-plus');?></a>
                    </div>
    ...
    <div class="row sfsiplus_xing_section">
        ...
        <label
            class="sfsiLabel infoLabel"><?php _e( 'The Xing icon can perform several actions. Pick below which ones it should perform. If you select several options, then users can select what they want to do:', 'ultimate-social-media-plus' ); ?></label>
    ...
    <div class="row sfsiplus_mastodon_section">
        ...
        <label
            class="sfsiLabel infoLabel"><?php _e( 'The Mastodon icon can perform several actions. Pick below which ones it should perform. If you select several options, then users can select what they want to do:', 'ultimate-social-media-plus' ); ?></label>

        <div class="col-md-12 sfsi_premium_tab2_checkbox_margin">
            <div class="row notopborder inr_cont sfsi_premium_d_flex_center">
                <input name="sfsi_plus_mastodonVisit_option"
                    <?php echo ($option2['sfsi_plus_mastodonVisit_option']=='yes') ?  'checked="true"' : '' ;?>
                    type="checkbox" value="yes" class="styled" />

                <label class="sfsiLabel">
                    <?php  _e( 'Visit my Mastodon profile page at:', 'ultimate-social-media-plus' ); ?>
                </label>
                <input name="sfsi_plus_mastodonVisit_url" type="url" placeholder="https://mastodon.social/@username"
                    value="<?php echo $option2['sfsi_plus_mastodonVisit_url'];?>" class="add" />
            </div>

            <div class="row notopborder">
                <input name="sfsi_plus_mastodonShare_option"
                    <?php echo ($option2['sfsi_plus_mastodonShare_option']=='yes') ?  'checked="true"' : '' ;?>
                    type="checkbox" value="yes" class="styled" />
