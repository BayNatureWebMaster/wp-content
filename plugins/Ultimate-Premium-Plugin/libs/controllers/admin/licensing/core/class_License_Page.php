	 ...
	 public function render(){  
	 	...
	 	<div class='wrap'>
			...
			<?php $license_api = get_sfsi_active_license_api_name();?>
	 		...
	 		<div class="license_api_containter"> 
	 			<label style="font-weight: 500;" class="license_api_name"><?php _e( 'I bought my plugin on ', 'ultimate-social-media-plus' ); ?></label><input type="radio" <?php echo strtolower($license_api) == "sellcodes_usm" ? "checked=true" : "" ?> name="license_api_name" value="sellcodes_usm"><label class="license_api_name" for="license_api_name"><?php _e( 'Sellcodes', 'ultimate-social-media-plus' ); ?></label>
	 			<input type="radio" <?php echo strtolower($license_api) == "ultimate" ? "checked=true" : "" ?> name="license_api_name" value="ultimate"><label class="license_api_name" for="license_api_name"><?php _e( 'Ultimatelysocial', 'ultimate-social-media-plus' ); ?></label>	 			
	 		</div>
