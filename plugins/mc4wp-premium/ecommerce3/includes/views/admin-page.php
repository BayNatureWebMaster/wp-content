...
<div id="mc4wp-admin" class="wrap ecommerce">
    ...
    <form method="POST">
        ...
        <table class="form-table">
            ...
            <?php $config = [ 'element' => 'mc4wp_ecommerce[enable_product_tracking]', 'value' => 1, 'hide' => false ]; ?>
            ...
            <?php $config = [ 'element' => 'mc4wp_ecommerce[enable_order_tracking]', 'value' => 1, 'hide' => false ]; ?>
            <tr valign="top" data-showif="<?php echo esc_attr(json_encode($config)); ?>">
                <th scope="row">
...
// show last updated timestamp
        ...
        <div class="mc4wp-margin-l">
            ...
            <p><?php printf(__('To use the e-commerce features, please start by <a href="%s">connecting your store to Mailchimp</a>.', 'mc4wp-ecommerce'), esc_attr(add_query_arg([ 'wizard' => 1 ]))); ?></p>
        </div>
        <?php
    } ?>
